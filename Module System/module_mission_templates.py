	...
	[
		...
		(0, 0, ti_once, [],
			[
				...
				(add_visitors_to_current_scene, 2, "trp_swadian_militia", 25),
				(add_visitors_to_current_scene, 2, "trp_swadian_footman", 12),
				(add_visitors_to_current_scene, 2, "trp_swadian_skirmisher", 12),
				(add_visitors_to_current_scene, 2, "trp_swadian_cavalryman", 9),
				(add_visitors_to_current_scene, 2, "trp_swadian_crossbowman", 5),
				(add_visitors_to_current_scene, 2, "trp_swadian_infantry", 5),
				(add_visitors_to_current_scene, 2, "trp_swadian_man_at_arms", 3),
				(add_visitors_to_current_scene, 2, "trp_swadian_noble2", 1),
			...
			[
				...
				(try_begin),
					...
					(try_for_range, ":div", 4, 8),
						(val_add, ":div", slot_team_division_0_state),
						(team_set_slot, 1, ":div", stds_reinforcement),
					(try_end),
				...
				(try_begin),
					...
					(add_visitors_to_current_scene, 2, "trp_swadian_infantry", 5),
					(add_visitors_to_current_scene, 2, "trp_swadian_man_at_arms", 3),
					(add_visitors_to_current_scene, 2, "trp_swadian_noble3", 1),
					(try_for_range, ":div", 0, 4),
						(val_add, ":div", slot_team_division_0_state),
					...
					(try_for_range, ":div", 4, 8),
						(val_add, ":div", slot_team_division_0_state),
						(team_set_slot, 2, ":div", stds_reinforcement),
					(try_end),
