  ...
  [#refill ammo every 1 minute 30 sec.
    ...
    (try_for_agents,":cur_agent"),
	  ...
	  (try_begin),
        ...
        (this_or_next|eq, ":agent_team", "$defender_team"),
        (eq, ":agent_team", "$defender_team_2"),
		# only change positions of defending bot
...
##  ),
  ...
  (
	...
	(ti_after_mission_start, 0, 0, [], 
       [
	     (team_set_relation, 0, 1, -1),
		 (store_random_in_range, "$ennemy_faction", "fac_kingdom_1", "fac_kingdom_9"),
		 (store_faction_of_party, ":faction_ennemy", "$g_starting_town"),
		 (try_begin),
		 ...
		 (try_begin),
		  ...
		  (try_begin),
			...
			(assign, ":t_1_arc", "trp_swadian_skirmisher"),
		  (else_try),
			...
			(assign, ":t_1_arc", "trp_vaegir_skirmisher"),
		  (else_try),
		  ...
		  (else_try),
			...
			(assign, ":t_1_arc", "trp_nord_huntsman"),
		  (else_try),
			...
			(assign, ":t_1_arc", "trp_sarranid_skirmisher"),
		  (else_try),
		    (eq, ":faction_ennemy", "fac_kingdom_5"),
			(assign, ":t_1_inf", "trp_rhodok_swordman"),
			...
			(assign, ":t_1_arc", "trp_rhodok_crossbowman"),
		  (else_try),
