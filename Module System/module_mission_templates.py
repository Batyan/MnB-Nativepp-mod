	...
	[
		...
		(30, 0, 0, [], # Handles reinforcements for both sides
			[
				...
				(try_begin),
					(lt, ":num_team1", 40),
					(add_visitors_to_current_scene, 1, "trp_swadian_militia", 30),
					(add_visitors_to_current_scene, 1, "trp_swadian_footman", 13),
					(add_visitors_to_current_scene, 1, "trp_swadian_skirmisher", 13),
					(add_visitors_to_current_scene, 1, "trp_swadian_cavalryman", 10),
					(add_visitors_to_current_scene, 1, "trp_swadian_crossbowman", 6),
					(add_visitors_to_current_scene, 1, "trp_swadian_infantry", 6),
					(add_visitors_to_current_scene, 1, "trp_swadian_man_at_arms", 4),
					(add_visitors_to_current_scene, 1, "trp_swadian_noble2", 2),
					(add_visitors_to_current_scene, 1, "trp_swadian_noble3", 1),
					(try_for_range, ":div", 0, 4),
						(val_add, ":div", slot_team_division_0_state),
						(team_set_slot, 1, ":div", stds_reform),
					(try_end),
				...
				(try_begin),
					(lt, ":num_team2", 40),
					(add_visitors_to_current_scene, 2, "trp_vaegir_scout", 15),
					(add_visitors_to_current_scene, 2, "trp_vaegir_footman", 15),
					(add_visitors_to_current_scene, 2, "trp_vaegir_veteran", 13),
					(add_visitors_to_current_scene, 2, "trp_vaegir_skirmisher", 13),
					(add_visitors_to_current_scene, 2, "trp_vaegir_light_cavalry", 10),
					(add_visitors_to_current_scene, 2, "trp_vaegir_archer", 6),
					(add_visitors_to_current_scene, 2, "trp_vaegir_infantry", 6),
					(add_visitors_to_current_scene, 2, "trp_vaegir_horseman", 4),
					(add_visitors_to_current_scene, 2, "trp_vaegir_noble2", 2),
					(add_visitors_to_current_scene, 2, "trp_vaegir_noble3", 1),
					(try_for_range, ":div", 0, 4),
						(val_add, ":div", slot_team_division_0_state),
						(team_set_slot, 2, ":div", stds_reform),
					(try_end),
					(try_for_range, ":div", 4, 8),
						(val_add, ":div", slot_team_division_0_state),
