	...
	[
		(ti_before_mission_start, 0, 0, [], 
			[
				...
				(faction_set_slot, "fac_kingdom_1", slot_faction_troop_9, "trp_swadian_noble2"),
				(faction_set_slot, "fac_kingdom_1", slot_faction_troop_10, "trp_swadian_noble3"),
				...
				(faction_set_slot, "fac_kingdom_2", slot_faction_troop_9, "trp_vaegir_noble2"),
				(faction_set_slot, "fac_kingdom_2", slot_faction_troop_10, "trp_vaegir_noble3"),
				...
				(faction_set_slot, "fac_kingdom_3", slot_faction_troop_9, "trp_khergit_noble2"),
				(faction_set_slot, "fac_kingdom_3", slot_faction_troop_10, "trp_khergit_noble3"),
				...
				(faction_set_slot, "fac_kingdom_4", slot_faction_troop_9, "trp_nord_noble2"),
				(faction_set_slot, "fac_kingdom_4", slot_faction_troop_10, "trp_nord_noble3"),
				...
				(faction_set_slot, "fac_kingdom_5", slot_faction_troop_9, "trp_rhodok_noble2"),
				(faction_set_slot, "fac_kingdom_5", slot_faction_troop_10, "trp_rhodok_noble3"),
				...
				(faction_set_slot, "fac_kingdom_6", slot_faction_troop_9, "trp_sarranid_noble2"),
				(faction_set_slot, "fac_kingdom_6", slot_faction_troop_10, "trp_sarranid_noble3"),
			]),
		...
		(0, 0, 0, [],
			[
				(try_begin),
					...
					(try_begin),
						(gt, "$g_team_1_faction", "fac_kingdom_6"),
						(assign, "$g_team_1_faction", "fac_kingdom_1"),
					(try_end),
				...
				(try_begin),
					...
					(try_begin),
						(gt, "$g_team_2_faction", "fac_kingdom_6"),
		...
		(0, 0, ti_once, [],
			[
				...
				(add_visitors_to_current_scene, 1, "trp_swadian_noble2", 1),
				...
				(add_visitors_to_current_scene, 2, "trp_vaegir_noble2", 1),
		...
		(30, 0, 0, [], # Handles reinforcements for both sides
			[
				(assign, ":num_team1", 0),
				(assign, ":num_team2", 0),
				(try_for_agents, ":agent_no"),
				...
				(try_begin),
					...
					(add_visitors_to_current_scene, 1, ":troop1", 15),
					(add_visitors_to_current_scene, 1, ":troop2", 15),
					(add_visitors_to_current_scene, 1, ":troop3", 13),
					(add_visitors_to_current_scene, 1, ":troop4", 6),
					(add_visitors_to_current_scene, 1, ":troop5", 13),
					(add_visitors_to_current_scene, 1, ":troop6", 6),
					(add_visitors_to_current_scene, 1, ":troop7", 10),
					(add_visitors_to_current_scene, 1, ":troop8", 4),
					(add_visitors_to_current_scene, 1, ":troop9", 2),
					(add_visitors_to_current_scene, 1, ":troop10", 1),
				...
				(try_begin),
					...
					(add_visitors_to_current_scene, 2, ":troop1", 15),
					(add_visitors_to_current_scene, 2, ":troop2", 15),
					(add_visitors_to_current_scene, 2, ":troop3", 13),
					(add_visitors_to_current_scene, 2, ":troop4", 6),
					(add_visitors_to_current_scene, 2, ":troop5", 13),
					(add_visitors_to_current_scene, 2, ":troop6", 6),
					(add_visitors_to_current_scene, 2, ":troop7", 10),
					(add_visitors_to_current_scene, 2, ":troop8", 4),
					(add_visitors_to_current_scene, 2, ":troop9", 2),
