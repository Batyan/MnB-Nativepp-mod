...
#Multiplayer troops (they must have the base items only, nothing else)
  ["swadian_crossbowman_multiplayer","Skirmisher","Skirmishers",tf_guarantee_all,0,0,fac_kingdom_1,
   ...
   str_11|agi_14|int_8|cha_4|level(16),		wpex(85,80,75,140,120,20),	knows_common|knows_ironflesh_2|	knows_athletics_5|	knows_power_strike_1|	knows_shield_2|	knows_power_draw_3,															swadian_face_young_1, swadian_face_old_2],
