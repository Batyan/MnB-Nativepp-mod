...
factions = [
  ...
  ("outlaws","Outlaws", max_player_rating(-30), 0.5,[("commoners",-0.6),("player_faction",-0.15)], [], 0x990000),
...
#  ("vaegir_caravans","Vaegir Caravans", 0, 0.5,[("outlaws",-0.8), ("dark_knights",-0.2)], []),
  ...
  ("kingdom_2",  	   "Kiralysag Vaegir",    0, 0.9,	     [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0xCCBB99),
  ...
  ("kingdom_5", 	   "Rhodok Empire",  0, 0.9, 			 [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x33DD33),
  ...
  ("kingdom_9",  	   "Khergit Tribe", 0, 0.9, 			 [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0xFF46FF),
  ("kingdom_10",	   "Freeriders", 0, 0.9, 				 [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x707070),
  ("kingdom_11", 	   "Mudle Confederacy", 0, 0.9, 		 [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x0000FF),
#  ("kingdom_1_rebel",  "Kingdom of Swadia Rebel", 0, 0.9,    [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x8E4729),
#  ("kingdom_2_rebel",  "Kiralysag Vaegir Lazado",    0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x7A6F5B),
#  ("kingdom_3_rebel",  "Khergit Khanate Rebel", 0, 0.9, 	 [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x7A5B99),
#  ("kingdom_4_rebel",  "Kingdom of Nords Rebel",    0, 0.9,  [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x1F8484),
#  ("kingdom_5_rebel",  "Rhodok Republic",  0, 0.9, 			 [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x1F841F),
#  ("kingdom_6_rebel",  "Sarranid Sultanate Rebel",  0, 0.9,  [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x84841F),
...
#  ("kingdom_5_rebels",  "Rhodok rebels",  0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0xCC2211),
  ...
  ("kingdom_7",  "Mercenaries",  0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], []),
  ("kingdom_8",  "Kingdom 8",  0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], []),
  ("robber_knights",  "{!}robber_knights", 0, 0.1, [], []),

  ("evil_1", "evil_1", 0, 0.9, [("deserters", -0.02),("manhunters",-0.3),("evil_2",-0.5),], []),
  ("evil_2", "evil_2", 0, 0.9, [("deserters", -0.02),("manhunters",-0.3),("evil_1",-0.5),], []),
  ("good_1", "good_1", 0, 0.9, [("outlaws",-0.3),("deserters", -0.2),("mountain_bandits", -0.2),("forest_bandits", -0.2),("evil_2",-0.5),("evil_1",-0.5),], []),
  ("neutral_1", "fac_1", 0, 0.9, [("outlaws",-0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("neutral_2",-0.5),], []),
  ("neutral_2", "fac_2", 0, 0.9, [("outlaws",-0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("neutral_3",-0.5),], []),
  ("neutral_3", "fac_3", 0, 0.9, [("outlaws",-0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("neutral_1",-0.5),], []),
  
  ("neutral_4", "Neutral", ff_always_hide_label, 0.9, [("outlaws",-0.3),("deserters", -0.2),("mountain_bandits", -0.2),("forest_bandits", -0.2)], []),
...
##  ("rebel_peasants","Rebel Peasants", 0, 0.5,[("vaegirs",-0.5),("player_faction",0.0)], []),
  ...
  ("deserters","Deserters", 0, 0.5,[("manhunters",-0.6),("merchants",-0.5),("player_faction",-0.1)], [], 0x990000),
  ("mountain_bandits","Mountain Bandits", 0, 0.5,[("commoners",-0.2),("merchants",-0.5),("manhunters",-0.6),("player_faction",-0.15)], [], 0x990000),
