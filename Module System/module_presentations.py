       ...
       [(store_trigger_param_1, ":object"),
        ...
        (else_try),
          ...
          (try_for_range, ":cur_troop", active_npcs_begin, ":end_cond"),
            ...
            (assign, ":end_cond", 0),
            (call_script, "script_assign_banner", ":cur_troop"),
			# (troop_set_slot, ":cur_troop", slot_troop_banner_scene_prop, banner_scene_props_end_minus_one),
		  ...
		  (troop_get_slot, ":banner_id", ":troop_to_change", slot_troop_banner_scene_prop),
          ...
          (try_for_range, ":cur_center", walled_centers_begin, walled_centers_end),
            ...
            (else_try),
              ...
              (party_set_banner_icon, ":cur_center", ":banner_icon_id"),
            (try_end),
          (try_end),
        (try_end),
        ]),
