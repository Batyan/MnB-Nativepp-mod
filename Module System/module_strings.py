...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_2", "Grof {s0}"),
  ("faction_title_male_3", "Sef {s0}"),
  ("faction_title_male_4", "War Lord {s0}"),
  ("faction_title_male_5", "Leader {s0}"),
  ("faction_title_male_6", "Emir {s0}"),

  ("faction_title_female_player", "Lady {s0}"),
  ("faction_title_female_1", "Countess {s0}"),
  ("faction_title_female_2", "Grofno {s0}"),
  ("faction_title_female_3", "{s0} Hatun"),
  ("faction_title_female_4", "War Lord {s0}"),
  ("faction_title_female_5", "Leader {s0}"),
...
##PBOD
  ...
  ("ladies_0", "{s0}"),
  ("ladies_1", "Baroness {s0}"),
  ("ladies_2", "Viscountess {s0}"),
  ("ladies_3", "Countess {s0}"),
  ("ladies_4", "Lady {s0}"),
  ("ladies_5", "Duchess {s0}"),
