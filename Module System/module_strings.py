...
#backstory main body
  ...
  ("npc24_backstory_b", "Not that I don't understand, would I be them, I wouldn't get close to a person with an axe in his back, especially if it concerns drinking."),
...
### use these if there is a short period of time between the last meeting
  ...
  ("npc20_signup_2", "I guess it would be enough for me to  protect your life as well. As that also makes me kill your ennemies."),
...
#11
  ...
  ("npc20_signup_response_2", "Eh... To be honest you're scary. And I don't want you to go rampage because you can't control yourself."),
