...
#npc20 = saorie
  ...
  ("npc17_intro", "You have the eyes of a leader, would you sit for a while and take a drink with me?"),
  ("npc18_intro", "No I don't sell anything, you can tell this to all your friends."),
  ("npc19_intro", "Hello. Let me introduce myself, people call me Aethrod and you can do the same. May I have the honor of knowing your name?"),
  ("npc20_intro", "Hail there friend, do you mind talking with me a little?"),
  ("npc21_intro", "Greetings traveller, are you looking for a mercenary to help you in battle?"),
  ("npc22_intro", "My good {man/woman}, are you looking for some help in your fighting?"),
  ("npc23_intro", "Greetings, my friend. Here to listen to the stories of an experienced warrior?"),
  ("npc24_intro", "Hail good {man/woman}, do you have time to share a drink with me?"),
  ("npc25_intro", "Well hello, what have we here? What is such a good looking {man/woman} doing in this tavern?"),
  ("npc26_intro", "Hello there, {sir/madame}, I say you are looking to hire some muscle."),
  ...
  ("npc17_intro_response_1", "Sure I always like to meet new people."),
  ("npc18_intro_response_1", "And I'm not here to buy anything."),
  ("npc19_intro_response_1", "I am {playername}. What do you want?"),
  ("npc20_intro_response_1", "No I don't, what is it?"),
  ("npc21_intro_response_1", "I might be. This mean you are one?"),
  ("npc22_intro_response_1", "I am yes, you're looking for someone to follow in battle?"),
  ("npc23_intro_response_1", "I guess you are that person."),
  ("npc24_intro_response_1", "I always have."),
  ("npc25_intro_response_1", "Just relaxing, why is that?"),
  ("npc26_intro_response_1", "Maybe I am, care to interest me in you?"),
  ...
  ("npc17_intro_response_2", "Not with a bandit."),
  ("npc18_intro_response_2", "I'll leave you alone."),
  ("npc19_intro_response_2", "Someone you shouldn't know."),
  ("npc20_intro_response_2", "I do, now back off."),
  ("npc21_intro_response_2", "Not at the moment."),
  ("npc22_intro_response_2", "I would be, if it was not for you."),
  ("npc23_intro_response_2", "No thanks. I enough stories for myself."),
  ("npc24_intro_response_2", "No drinking for me, you should do the same."),
  ("npc25_intro_response_2", "Minding my own buisness, you should do the same."),
  ("npc26_intro_response_2", "You're wrong I am not."),
...
#backstory intro
  ...
  ("npc14_backstory_a", "Very well. I do not mind. My name is Lezalit."),
  ...
  ("npc17_backstory_a", "Allow me to introduce miself, I am Sverre, let me tell you my story."),
  ("npc18_backstory_a", "My most humble apologies, I am Seis Utis, the son of Hem Utis, best trader I've ever seen."),
  ("npc19_backstory_a", "Well as you may know these are hard times for everyone and I am no exception to the rule."),
  ("npc20_backstory_a", "Good. I ran into a few troubles recently, you see, I began wandering around Calradia as a sort of... eh... adventurer you'd say, but it is not working as I'd expected."),
  ("npc21_backstory_a", "I surely am {sir/madame}, I used to be in the swadian army you see, under the banner of King Harlaus himself."),
  ("npc22_backstory_a", "I am indeed, and I can advice you to take me as one of your follower. Name's Ysellian."),
  ("npc23_backstory_a", "It is me indeed, you may call me Khutza. I was a captain in the garrison of Halmar."),
  ("npc24_backstory_a", "Ah! You know, you are the first one to accept a drink from me. I got used to people being scared of me."),
  ("npc25_backstory_a", "Oh there is nothing in particular, I was just surprised to find someone like you in this place."),
  ("npc26_backstory_a", "Merek is my name, I am one of the best you can find if you're looking to get someone hurt or better, killed."),
...
#backstory main body
  ...
  ("npc17_backstory_b", "In a far away land, I was a poor man, looking for a job, but no one wanted a fatherless children like me, because they said I was not strong enough to do all the work, well they were right. Once someone took me for a work in a farm, a very good family, I started to consider them as mine. But in a stormy day, a group of looters came, they killed everyone but me, I was scared first, but as time passed, I became furious, I wanted to make them pay for what they did, so I started to take arms, to train myself, and when I was ready, I searched them, and killed them, burning their village and killing everyone. I then began to do this, to everyone, to everything. But these land where poor, so I thought about leaving and coming on another land, I travelled and I found Calradia."),
  ("npc18_backstory_b", "But because of him, people always ask me to sell them things I don't even know, someone even told me he will kill me when I'll leave this tavern, well I'm here for a while I think."),
  ("npc19_backstory_b", "Hopefully for me, my problems are not as dangerous or as important as the others', but still, this is something I must deal with."),
  ("npc20_backstory_b", "With all these bandits roaming around, I got beaten up a few times already. And before you ask, yes, I tried to fight back, but being alone against a dozen of them is not an easy task, hopefuly for me I was so badly wounded they thought I was dead. And a group of peasant was passing by a few hours later, they patched me up and I thought I had to do something against that, I collected a few men from the surrounding villages. Oh! These men can't even hold a stick properly!"),
  ("npc21_backstory_b", "It was some good times, he pays well his soldiers, especially those doing a good job. Problems started when we went at war with these Khergits, damn good warriors they are, deadly with a bow. And well, as it had to happen, we met Sanjar Khan on the field, a bloody battle was preparing. At the begining we were dominating them, our cavalry devastating their infantry lines like a knife through butter."),
  ("npc22_backstory_b", "I come from a family of hunter, my father was one, my grand father was one too. We used to hunt all together until I reach the age of 19, at that point I left the house in search of adventures. Well I did find them, I took part of a small militia hunting sea raiders. These men are tough and are well equiped for bandits, if you ever come across them I'd suggest you avoid these men, unless you outnumber them two to one."),
  ("npc23_backstory_b", "A big town that is. It also has the advantage of being one of the few passage to the Sarrdak Desert, it makes passing trading caravans stop for a rest before facing the heat of the desert. Well of course, it also makes it a perfect target for both the Swadian and the Sarranian siege."),
  ("npc24_backstory_b", "Not that I don't understand, if I were them, I wouldn't get close to a person with an axe on his back. Especially if it concerns drinking!"),
  ("npc25_backstory_b", "You have most likely never heard of me, so allow me to introduce myself, I am Ireth, former mercenary and women in search of love. On another subject I think we both know that you are a pretty person, physically speaking."),
  ("npc26_backstory_b", "I can do it how you want, with what you want. If you ever want someone dead, killed with say... A broom, I'll do it for you, and if you want him, or her, dead drown in a fountain, I can also do that."),
...
#backstory recruit pitch
  ...
  ("npc17_backstory_c", "Time passed as I grew up, with my hatred going down, I reminded all things I did, and I became sick of it, of all things I liked to do, so I ran away when my men weren't looking and I found this town, a safe place far away from sea riders, and a place where I could find someone to hire me."),
  ("npc18_backstory_c", "Maybe you could help me, get me out of this city and I'll stay with you, what do you say?"),
  ("npc19_backstory_c", "If you do not know this it may be because I only am here since a very short time, I usually travel around Calradia in search for something I don't know. Back to the point, some hysterical girls track me and want me to marry one of them. And you look like the kind of person that could help me get out of this trap."),
  ("npc20_backstory_c", "Now I come to wonder. You look like someone that do this kind of things... and I guess you do it better than I. Are you by any chance looking for someone to back you up in fight?"),
  ("npc21_backstory_c", "Then, their cavalry showed up, so many of them, we could field about one third of our army as horsemen, they had two third as cavalry. That was impressive, our mounted warriors were outnumbered and our archer line got overrun. It was one big mess. At some point I got separated from my comrades, a bad mistake I made, half a dozen mounted archer started following me, they took out my horse first, I tried to protect myself with my shield, but hey! This thing is good when you are on a horse, not when there is arrows flying everywhere, I guess you know what happened next, I got shot, in the knee, I couldn't stand the pain so I fell down, they thought I died, I got lucky here. I started crawling my way out of the battlefield with my crossbow still loaded, in case someone would come to see me."),
  ("npc22_backstory_c", "In my case, we were a band of rabble, barely enough armor to avoid a cut from a kitchen knife. When we met them we had to rely on tactics to get them, we had numerous bowmen, so we used that to pin them down, it sort of worked, as they got closer the already sustained heavy losses. When in contact, they did sort of kill a lot more than what they had left. But in the end we still beat them with only a few wounded, thanks to our superior tactics."),
  ("npc23_backstory_c", "But I digress, back to me, as I told you I am an experienced fighter, and I can teach the men how to defend themselves, my work as a captain helping in this part."),
  ("npc24_backstory_c", "It's just that I would like for once someone whom I can share my adventures with, I've been alone since... Well since quite a good amount of time, in fact I don't even remember ever having a partner."),
  ("npc25_backstory_c", "I think I could do this all day, complimenting your person, but we should stop beating around the bush, are you interested in me?"),
  ("npc26_backstory_c", "My last employer didn't really see how much I care for my work, he clearly asked me to 'put an end' to someone's life, how was I to know that he only meant 'put an end' to his life of merchant by forcing him to sell all he had."),
...
### use these if there is a short period of time between the last meeting
  ...
  ("npc17_backstory_later", "I went throught all cities of Calradia, no one wants a man like me, reminds me of the old time, I hope I'll find another family, and that this time I'll be able to defend it."),
  ("npc18_backstory_later", "Am I a jinx? They don't want to leave me alone."),
  ...
  ("npc20_backstory_later", "I tried again, failed again, I am sure there is one little thing I am missing but... I can't seem to find it."),
  ("npc21_backstory_later", "I couldn't quite find what I was looking for, my proposition still holds if you want."),
  ("npc22_backstory_later", "I'd like to lead another group of men, sadly no one wants to give me a chance."),
  ("npc23_backstory_later", "No one wants a skilled fighter in their band? They surely want to die."),
  ("npc24_backstory_later", "Nothing more to add than that last time, not too many people dare to get close to me."),
  ("npc25_backstory_later", "Still not interes... ready to allow me to be with you... as a companion?"),
  ("npc26_backstory_later", "I get that you are not here to give me a hug, so want me to join you?"),
  ...
  ("npc17_backstory_response_1", "I may be able to help you, what can you do?"),
  ("npc18_backstory_response_1", "What would be in it for me?"),
  ("npc19_backstory_response_1", "What if I am?"),
  ("npc20_backstory_response_1", "It's always better to have someone look for your back. What are you good at?"),
  ("npc21_backstory_response_1", "So? What happened next?"),
  ("npc22_backstory_response_1", "Interesting, and you were the one leading those men?"),
  ("npc23_backstory_response_1", "If I already have experienced fighters under my lead, what can you bring more?"),
  ("npc24_backstory_response_1", "And so? Care to share your adventures with me?"),
  ("npc25_backstory_response_1", "I'm sorry, what?"),
  ("npc26_backstory_response_1", "It's pretty confusing yes."),
  ...
  ("npc17_backstory_response_2", "I understand why no one wanted you when you were young, it's because you're uncontrolable."),
  ("npc18_backstory_response_2", "Sorry I don't want to get into troubles."),
  ("npc19_backstory_response_2", "I think you are searching for bravery and I am not that."),
  ("npc20_backstory_response_2", "I'd rather have experienced fighters in my ranks."),
  ("npc21_backstory_response_2", "So you're a deserter? Good bye."),
  ("npc22_backstory_response_2", "I don't think you should be proud of beating a few bandits."),
  ("npc23_backstory_response_2", "I fear you might 'digress' also in battle, and I don't want to have you die under my command because of that."),
  ("npc24_backstory_response_2", "It's better for you if it stays this way. Good day."),
  ("npc25_backstory_response_2", "Heh... No thanks, I will go."),
  ("npc26_backstory_response_2", "By thinking, you know, with your brain."),
  ...
  ("npc17_signup", "As I said I'm used to kill my foes quickly, with an axe usually."),
  ("npc18_signup", "I know how to trade with people, I got it from my father, I can heal the wounds of men too."),
  ("npc19_signup", "Well I think that we will be able to fool them, making them believe that {we are in the same family, you will then be able to dismiss them./you and me are... You know that we will make babies and all what goes with it.}"),
  ("npc20_signup", "I can do whatever you want me to do, as long as it is about killing people."),
  ("npc21_signup", "Well I did at some point get just in front of a khergit tribesman, not the fearsome one, but I was in a bad position to fight, as I couldn't get up. He got closer, but did not see my crossbow. I quickly aimed at his head and released the shot. He fell over me. He was the weight of a dead horse, or maybe it was because of that damn arrow. But I was happy he couldn't come closer, who knows what he could have done if he knew I was a woman."),
  ("npc22_signup", "Well I was not at first, but the leader got shot inbetween the eyes right after we started the battle, those sea raiders uses bows as well, deadly longbows."),
  ("npc23_signup", "An good warrior I am, proficient with a lance and on a horse, just like most of my people, but I am also a good trainer for your men and can probably give you some advice on your tactics."),
  ("npc24_signup", "That is... You're taking the words out of my mouth, I can guarantee you that I am a disciplined soldier, I will obey your every orders, even if they are stupid ones, I don't care. I got used to fight my way out of tricky situations during my travels."),
  ("npc25_signup", "It's... not what I meant, I am so embarrased... I meant that I am looking for a leader to hire a mercenary like myself, I didn't mean to say it this way."),
  ("npc26_signup", "Truly right? So he then told me to run away before he calls the lord's men to put my head on top of a spike."),
  ...
  ("npc17_signup_2", "I will do all I can to serve you."),
  ("npc18_signup_2", "And the best of all, I know how to cook you an excelent lemon duck."),
  ("npc19_signup_2", "I will be forever in debt with you for helping me out."),
  ("npc20_signup_2", "I guess it would be enough for me to protect your life as well. As that also means killing your enemies."),
  ("npc21_signup_2", "This is basically the only thing that happened, I remember after that a big silence, a very pleasing one. I never knew if we won that battle as no side would have even bothered gathering the corpses, the dead and wounded had lost it, not the leaders."),
  ("npc22_signup_2", "I took the lead immediatly after, as everyone else was just paralized by what just happened. Organized firing teams and sent the men on their positions."),
  ("npc23_signup_2", "Other than this, well, I am not a good trader, neither am I a tracker and I have absolutly no idea on how to heal a wound. But I can guarantee you that my skills in combat are worth more than all this."),
  ("npc24_signup_2", "And if you ever need someone to cover your back, I will be here, ready to cut your foes in half."),
  ("npc25_signup_2", "I am... I present you my most humble apologies, but, you are so attractive... I... I am going out of the subject, so... Interested? I am a fine rider and an obedient soldier, I was working for some mercenary captain until he decided to buy some land and start his own farm, I say he was a bit crazy."),
  ("npc26_signup_2", "I didn't really appreciate that, he threaten me for a job perfectly done, no one could suspect him or me, I dared him to do it, what he did, I then put my sword through his neck, leaving him bleeding on the ground. All I am asking now, is another employer to start over again, without senseless killing and threatening."),
  ...
  ("npc17_signup_response_1", "Great we need some experienced men like you."),
  ("npc18_signup_response_1", "All right, you come with me."),
  ("npc19_signup_response_1", "Right but after that you don't talk about me being in your family."),
  ("npc20_signup_response_1", "Exactly what I was looking for, you're in."),
  ("npc21_signup_response_1", "Sounds like you are a tenacious one, I like that."),
  ("npc22_signup_response_1", "Sounds good, that mean you can even take care of the men in case of need."),
  ("npc23_signup_response_1", "I believe you, you're in."),
  ("npc24_signup_response_1", "I think you convinced me."),
  ("npc25_signup_response_1", "I can make a place for you."),
  ("npc26_signup_response_1", "I could be what you're looking for."),
...
#11
  ...
  ("npc17_signup_response_2", "It's a no, I'm not used to work with bandits."),
  ("npc18_signup_response_2", "If this is the best you can do I don't think you'll be able to leave this town."),
  ("npc19_signup_response_2", "Tricky plan, find someone else."),
  ("npc20_signup_response_2", "Eh... To be honest you're scary. And I don't want you to go on a rampage just because you can't control yourself."),
  ("npc21_signup_response_2", "I'd rather have someone who win battles with me."),
  ("npc22_signup_response_2", "I wouldn't be surprised to learn that you shot him just to get all the glory out of it."),
  ("npc23_signup_response_2", "By the look of it, you look more like a bandit in armor."),
  ("npc24_signup_response_2", "I think I prefer my men to think before acting."),
  ("npc25_signup_response_2", "You are the crazy one, now step away from me."),
  ("npc26_signup_response_2", "Haven't seen any, sorry."),
  ...
  ("npc17_payment", "It saddens me to tell you this, but I need some money before I can go, as a proof you're the good person, {reg3} denars will be enought."),
  ("npc18_payment", "{!}."),
  ("npc19_payment", "{!}."),
  ("npc20_payment", "There is something I would ask before I can join you, a small payment of {reg3} denars to make sure I am not going with a poor {man/woman}."),
  ("npc21_payment", "Good thing, I would just ask a payment of {reg3} denars to start with, then let's say... a small sum of 50 denars a week?"),
  ("npc22_payment", "As you seem interested in me, I must tell you that you will have to pay me a little something before I can join you up, {reg3} denars will do."),
  ("npc23_payment", "Now, I would ask a payment to seal off agreement, {reg3} denars will suffice."),
  ("npc24_payment", "Very good then, there is one thing I would like to ask you before allowing me to join you, and that is asking a small amount of money, {reg3} denars, to make sure I can leave this place with a free mind."),
  ("npc25_payment", "Erm... I would also like... a small payment to.. you know, seal off our agreement, how about {reg3} denars?"),
  ("npc26_payment", "Amazing! As I told you, I can get mostly anyone to bow before me before I give him whatever cure you asked me to give him, if you know what I mean. All I ask in return is a small early payment of {reg3} denars to make sure you're not here to trick me."),
  ...
  ("npc17_payment_response", "All right, here's {reg3} denars for you. Make yourself ready to leave."),
  ("npc18_payment_response", "{!}."),
  ("npc19_payment_response", "{!}."),
  ("npc20_payment_response", "Here's your proof, {reg3} denars."),
  ("npc21_payment_response", "Sure, {reg3} denars for you. And about your payment, we'll negociate that later."),
  ("npc22_payment_response", "You're hired, and {reg3} denars for you."),
  ("npc23_payment_response", "Of course, {reg3} denars for you."),
  ("npc24_payment_response", "Yes... {reg3} denars for you."),
  ("npc25_payment_response", "Very well, here are your {reg3} denars."),
  ("npc26_payment_response", "No trickery, {reg3} denars for you."),
  ...
  ("npc17_morality_speech", "{Sir/Madame} I'd prefer not to {s21}. I want to forgot all these things I did in the past."),
  ("npc18_morality_speech", "It is not my habit to complain but I must tell you that I don't like to {s21}, it is a shame for a leader to have to humiliate himself this way."),
  ("npc19_morality_speech", "{playername}, I am not sure if you understand what war is all about, but it is not meant to {s21}."),
  ("npc20_morality_speech", "I don't undestand why you would want to {s21}, I really can't."),
  ("npc21_morality_speech", "Sorry to interupt you captain, but it is not good that we {s21}."),
  ("npc22_morality_speech", "Keeping an army happy with the food they have is not an easy task I can give you that, but that we come to the point where we {s21} is just impossible to comprehend."),
  ("npc23_morality_speech", "I am having hard time trying to know how you've come to a point where we {s21}. I don't think it's so hard to keep your men fed of at least the worst of the food."),
  ("npc24_morality_speech", "{Sir/Madame} I am here to make sure that you're aware we {s21} and I hope you intend to do something about it."),
  ("npc25_morality_speech", "{playername}, we've crossed the line where we {s21}, I don't think the men appreciate that."),
  ("npc26_morality_speech", "Captain, it has come to the men's head that we {s21}, I've always thought starvation was a dirty way of killing someone, and at least I'd hope that you were to spare my life when you would try such thing."),
  ...
  ("npc17_personalityclash_speech", "{Sir/Madame} may I ask you what is wrong with this man called {s11}?"),
  ("npc18_personalityclash_speech", "{playername} this {s11} is getting on my nerves, he keeps calling me weak."),
  ("npc19_personalityclash_speech", "{playername}, I'm not sure in what bazaar you found that idiot of {s11}, but I should warn you that a man with no strength such as him should not be allowed to raise a sword in honor of someone."),
  ("npc20_personalityclash_speech", "This man, {s11} is an odd one, he told me that with the natural beauty I have, should not be wasted in wars."),
  ("npc21_personalityclash_speech", "You know why I've always hated the people of Vaegir? Because they are heartless beast with only one goal to kill and get a profit out of it."),
  ("npc22_personalityclash_speech", "{playername}, I must ask you why you would let this {s11} accompany you, with her superior ways of thinking, and her hatred for anything that does not respect Her way of thinking."),
  ("npc23_personalityclash_speech", "If I can tell you something about my people, I will tell you about the endless wars we have against the vaegirs, because yes, they are one of our biggest ennemies, and you want to know why?"),
  ("npc24_personalityclash_speech", "{Sir/Madame} can I ask you where you found that arrogant wench that calls herself {s11}?"),
  ("npc25_personalityclash_speech", "{playername} I would greatly appreciate if you could do something about {s11}, he might be a good soldier and a great fighter, but in battle, he is like an annimal without his chains."),
  ("npc26_personalityclash_speech", "Did I ever tell you a story about how peasants could be a big threat?"),
  ...
  ("npc17_personalityclash_speech_b", "He seems to have something against me, I can't really find the reason why, but if he keeps doing like that I might as well chalenge him in a duel to the death, we will see who's the weakest then."),
  ("npc18_personalityclash_speech_b", "I know he's the weak one, he just doesn't understand strength comes from the mind, not from his physical capacities. But anyways, I don't appreciate this sort of remark, you should tell him to shut his mouth if he wants to keep his little dignity."),
  ("npc19_personalityclash_speech_b", "I was checking if the ennemies were dead from the last battle, when he came by and said 'You should not treat the deads like you do' I wonder why a man not capable of carrying a body can allow himself to give me orders, and furthermore, sensless orders, a dead is dead, he will not complain if you cut his arm to check if he is dead."),
  ("npc20_personalityclash_speech_b", "He can't tell me what to do, I could kick his puny arse with my eyes closed. If I want my hands full of blood because I enjoy it, it's my choice, it's not a frail merchant that will change my mind. He should learn to keep his place as the lowly trader he is."),
  ("npc21_personalityclash_speech_b", "I don't always make generalities out of phrases like this one, but {s11} is not making his people look like civilized and educated people. Just saying."),
  ("npc22_personalityclash_speech_b", "My opinion is that she should get back to her old king and lick his boots once more, maybe one day he will accept that she goes further close to her life goal."),
  ("npc23_personalityclash_speech_b", "Well it's simple, these snow men are just annimals, no brain and no thinking. Their only actions are dicted by their so called 'king', which takes a pleasure in manipulating his little puppets, what {s11} clearly doesn't want to understand."),
  ("npc24_personalityclash_speech_b", "I don't see what she is doing in a profesional army like yours, she told me her story about 'How she survived during the battle near Reindi castle'. Bah! I would call that 'How she ran away from her duties as a warrior in the king's army'."),
  ("npc25_personalityclash_speech_b", "He gets happy when he kills people, he even told me he would like to get killed during a battle, 'tis would be an honor' he told me. Can you understand that?"),
  ("npc26_personalityclash_speech_b", "Oh, you see these men who call themselves rhodok people, the men of the mountains? Yes I call them peasants, you knew they take women in their army too? Yes I am talking about {s11}, she just shouldn't be able to hold anything other than a kitchen knife her emotions being to much of a annoyance to fight well."),
...
### set off by behavior after victorious battle
  ...
  ("npc17_personalityclash2_speech", "What is this women called {s11} you've allowed to follow us?"),
  ("npc18_personalityclash2_speech", "{s11} is a beautiful woman, if I can suggest you something it would be to tell her you can't allow her to be with us anymore."),
  ("npc19_personalityclash2_speech", "I have a request {playername}, and it is that you throw this weak {s11} back in his bandit camp."),
  ("npc20_personalityclash2_speech", "Who is this arrogant thug called {s11}? He's been telling me to get treated for my sickness."),
  ("npc21_personalityclash2_speech", "Captain, I would want you to order {s11} to keep his voice down when talking to me."),
  ("npc22_personalityclash2_speech", "Would you allow if I were to kill {s11}?"),
  ("npc23_personalityclash2_speech", "My friend, if I allow myself to interupt you it's because I have an urgent matter to discuss with you, it's about {s11}."),
  ("npc24_personalityclash2_speech", "Have you ever wondered why the rhodok people hides in their highlands?"),
  ("npc25_personalityclash2_speech", "{playername}, this is a terrible shame that you allowed {s11} to come with us, he's just way to insolent to have a place here."),
  ("npc26_personalityclash2_speech", "Captain, I must had to tell you about {s11}, he should not be able to give me orders, I'm more than what he is in this army."),
  ...
  ("npc19_personalityclash2_speech_b", "This kind of man will never become normal again, he's been too much used to banditry, he cannot be forgiven for what he has done. And the fact that he plays as a smart and delicate man is making it worst, I suggest he is make a sort of plot against us, you should be careful when he's nearby."),
  ("npc20_personalityclash2_speech_b", "He tells me I am insane, pointing me to one of his 'friends' because he knows how to cure that. I am not insane, he's the one that should get treated, he's not normal for an ancien bandit, he's even less normal for a man."),
  ("npc21_personalityclash2_speech_b", "He keeps yelling at me like I'm half deaf. He insulted me as being a coward after I told him about my misadventure with the Khan. I won't allow him to treat me like that for long, captain, you should be the one doing something about it."),
  ("npc22_personalityclash2_speech_b", "I'm just wondering if it's worth doing it. He keeps insulting our people, and doesn't want to understand that the only reason we don't come and push them back to where they come from is because our armies are busy with fighting the fierce and strong warriors of the nord, unlike them, pathetic soldiers, barely capable of holding a spear correctly."),
  ("npc23_personalityclash2_speech_b", "I would simply ask that you get rid of this person, he thinks of himself as a superior person, telling us you apointed him as your bodyguard, I hope it's all just lies, but even if it's true I wouldn't trust a man like him, you never know what the sand people are about to do when it comes to money."),
  ("npc24_personalityclash2_speech_b", "I think I know the reason, it's because no one likes them, their pathetic armies made of peasants. To have an army you can't give a farmer a stick and tell him to hold the line, you have to make sure that this peasant is strong enough to fight. That's why we didn't come in Calradia with our wives, {women/most women} are weak, and so is {s11}."),
  ("npc25_personalityclash2_speech_b", "He's always after me, asking me why I didn't want to stay home and find a man to take care of, I keep telling him that it's none of his buisness, and that I prefered it this way, but he doesn't want to give up, this time he insulted me of being weak, I am sure I can take him... In a duel of course... and still win."),
  ("npc26_personalityclash2_speech_b", "I would want you to tell him to listen to me next time, as this half-man could get into trouble if I have my sword in hand when he doesn't obey."),
  ...
  ("npc17_personalitymatch_speech", "{Sir/Madame}. I like very much the way {s11} sees the world around him."),
  ("npc18_personalitymatch_speech", "{playername}, I happened to be speaking with {s11}, this man is a well of knowledge, he can understand every conversation I have with him, and he can add his own thoughts to it."),
  ("npc19_personalitymatch_speech", "I was just speaking with {s11}, she is meant to be with me."),
  ("npc20_personalitymatch_speech", "{playername}, I am not sure how to say this, but do you think love is a sign of weakness?."),
  ("npc21_personalitymatch_speech", "Captain. I was having a little talk with {s11} and I learned that he saw the battle in which I told you I fought near Reidi Castle."),
  ("npc22_personalitymatch_speech", "That's a nice little girl you've got yourself here. {s11} is a nice and delicate person."),
  ("npc23_personalitymatch_speech", "I was talking with {s11} just a few minutes from now, she is a quite impressive women."),
  ("npc24_personalitymatch_speech", "{s11} is a strong warrior, you are lucky to have found him during your travels."),
  ("npc25_personalitymatch_speech", "I was talking with {s11} after that last battle, he taught me a lot about himself and his people."),
  ("npc26_personalitymatch_speech", "Captain, I understand your choice of letting {s11} accompany you, he is a great fighter."),
  ...
  ("npc17_personalitymatch_speech_b", "He thinks that everything can be good if you look at its bright side, I think he's right, and it spurs me to keep going."),
  ("npc18_personalitymatch_speech_b", "I'm surprised that a nord like him can be such a smart, from my travels, I've never seen one of his kind being so educated, and he told me he learned by himself! That will learn me to have prejudices on people."),
  ("npc19_personalitymatch_speech_b", "You know she is so beautiful, she is funny and she knows how to fight with a sword how could a man like me resist. I don't know if I have to say it to her, she might get scared. Please do as if I didn't tell you anything."),
  ("npc20_personalitymatch_speech_b", "I say this because... well there is this {s11}, he... I don't know what to say when I am infront of him, I fell empty of everything you are a {man/woman} so you must {know how men feel on this subject/be better than I at this}. Oh well... nevermind I don't even think he's onto me anyway. It's still a pleasure to have him close to me during the fight."),
  ("npc21_personalitymatch_speech_b", "He was stationned in the city of Halmar when it happened, from there he saw nearly all of what happened. He assured me that the king of swadia won that battle, but had too many wounded to keep going for a siege. I admit that I admire the passion in the khergit tribesmen, they gave us a really good fighting that day."),
  ("npc22_personalitymatch_speech_b", "She sometimes has trouble hiding her feelings, mostly those about... intimate ones, with {men/women} like you, if you know what I mean. But that is what makes her charm right?"),
  ("npc23_personalitymatch_speech_b", "I bet she told you of her story? Well, I can guarrantee you that she had no chance of taking these horse archers all by herself, we are trained in taking cavalrymen out by cripling their horse, then circling around him when dismounted to allow him no chance. She was brave to try to fight, and to keep her moral even after being on the ground."),
  ("npc24_personalitymatch_speech_b", "I've always admired his people, I'm curious on how they can fight and live in their desertic areas, and the fact that they can fight well outside is impressive as well. We and them, have some similarities, we prefer fighting with our own hands than fighting with bows, or worst, crossbows, these weapons are for weak. They understood it, so their men got used to throw projectiles with their own hands, which is a proof of strength."),
  ("npc25_personalitymatch_speech_b", "They live where there is snow, during most of the year, if not all. We, in the highlands, have a hard climate, but it's not as much as what they endure. And so {s11} told me on the ways to survive in the taiga, I was fascinated, and I learned a lot from him. It's good to have such a fine person to talk to."),
  ("npc26_personalitymatch_speech_b", "Before that last battle, he showed me a few tricks on how to hold a two handed weapon, as I was used to hold a sword with one hand, he taught me a little of what he knows about axes, for example, that axes could put off-balance a man trying to parry his strickes, allowing the time to hit again, until it breaks his shield, his weapon, or his arm. That was very interesting to learn, and I'm glad to fight him."),
  ...
  ("npc17_retirement_speech", "{Sir/Madame}. It was a great experience being in this company, I learned to overlook my past and this is a good thing, but I must leave, as I think I have to search for the real family I had expeceted, this is surelly not you"),
  ("npc18_retirement_speech", "This is not that I don't like you, but I must leave, I can find better elsewhere."),
  ("npc19_retirement_speech", "I had great moments with you, but I need to go on my own right now for some time."),
  ("npc20_retirement_speech", "I think you and I have different point of view, not that I don't respect yours, it's sometimes difficult to understand you, I think it is time for me to try and find something somewhere else, you've been a great help to me and I will never forget that."),
  ("npc21_retirement_speech", "Captain, you were the first one person to inspire me, I would like someday to become just like you, or at least in your position, sadly there is things I don't understand in your decisions, that is why I will leave your service."),
  ("npc22_retirement_speech", "It was a great adventure we had {playername}, but I'm afraid I will have to leave you, at least for a moment, I hope you keep being lucky even without me."),
  ("npc23_retirement_speech", "I've had good times in this company, but it's time for me to breath a little. Farewell my friend, I hope we will see each other again soon."),
  ("npc24_retirement_speech", "Time has come that I leave your service {sir/madame}, I have a small problem with the way you lead us, it's not against you."),
  ("npc25_retirement_speech", "{playername}, I would have liked to know you more, and to enjoy of your presence a little more... But I'm afraid I must leave you, your leadership being slightly different from what I expected."),
  ("npc26_retirement_speech", "It has come to a point, Captain, where I need to leave your services in search of something else, I hope you will forgive me for letting you like that, but life is hard and one has to make difficult choices sometimes."),
  ...
  ("npc17_rehire_speech", "{Sir/Madame} it's good to see you again, I searched for some sort of family, and I think I was wrong, you're the best that can be on earth."),
  ("npc18_rehire_speech", "I know what you are thinking, 'How stupid he is to be in same situation he was before' I know, but my old friends came back, I don't think I'm as good as when I was on your band."),
  ("npc19_rehire_speech", "I must admit that I was stupid to leave you, you are one of the best leader of all times and to tell the truth people always asked me why I left you, I had no reason. So would you take me back?"),
  ("npc20_rehire_speech", "Oh it's you, {playername}, I've been trying again you see, followed your example, but I can't seem to do anything with what is given to me, I guess I am not, unlike you, a good leader. Plus, you seem to bring me luck, is it too much for me to ask that you take me back?"),
  ("npc21_rehire_speech", "Oh! Captain! I was losing hope of seeing you again, I didn't get lucky in your absence, I nearly got captured by bandits on my way here. I would be a pleasure if you'd allow me to join you again captain."),
  ("npc22_rehire_speech", "I was reminding the great times I had when under your orders {playername}, would you allow me to join you again?"),
  ("npc23_rehire_speech", "My friend! I have come to think breathing alone is not a good idea, or at least it's not a long term good idea. I could join you again, if you would ask me to."),
  ("npc24_rehire_speech", "{Sir/Madame}, my apologies, I was being rude last time we parted ways, I guess I didn't have all my mind after taking a blow to the head, are you ready to let me join again?"),
  ("npc25_rehire_speech", "{playername}, I'm really excited to see you again, you've missed me... I mean... I miss the times we've had together... Ehm... I would be honored if you would ask me to come with you again."),
  ("npc26_rehire_speech", "It is you, captain! I believe I've mad a mistake when I left you on this hard world. Or I made a mistake trying to go on my own, either way I am ready to join you if you want me again."),
...
#local color strings
  ...
  ("npc17_home_intro", "This place reminds me of the old time, we must be near the place where I landed."),
  ("npc18_home_intro", "Such a lovely place this is, did you know I was born here?."),
  ("npc19_home_intro", "I went in this small village before, people from here have to face tough weather, that may be the reason why they are really welcoming."),
  ("npc20_home_intro", "Ah! {playername}, we must be getting close to my birthplace."),
  ("npc21_home_intro", "This is close to here, I guess."),
  ("npc22_home_intro", "I think we are close to the place of the battle with the sea raiders, or at least that's where the militia was formed, in Jeirbe Castle."),
  ("npc23_home_intro", "Do you remember when I told you I was a captain in this town, Halmar?"),
  ("npc24_home_intro", "We're close to Jelbegi Castle, this is the place where I've learned how to fight properly."),
  ("npc25_home_intro", "I smell the warm air of my past. That means we shouldn't be far from Jamiche."),
  ("npc26_home_intro", "Mazigh, it's the place was born in. Just before the mountains surrounding Sarrdak Desert."),
...
#  ("npc13_home_description", "I had come up here with a small Swadian force, but they were caught by the Rhodoks in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ("npc17_home_description", "This is a wonderful place, and this may be the only my band and I didn't loot."),
  ("npc18_home_description", "Well you know, we were entirely devoted to the goodwill of this village, it had huge palms around everywhere, a well for water, the prosperty of this place had nothing to envy to the big cities around here, you know people were rich."),
  ("npc19_home_description", "When I was still a little boy, my parents came here, because of the war, the soldiers told us to go away from our home, we resisted, but my father was wounded and this village became our shelter."),
  ("npc20_home_description", "You know, this place was my bit of heaven in my youth, cold climate for sure, but the people were so welcoming that you completely forgot how hard it was to live."),
  ("npc21_home_description", "The place where I fought that battle, the one that gave me an arrow as a present. I think we went there to get the enemy away from one of our castle, Reindi it was."),
  ("npc22_home_description", "We were mostly peasants, hunters and fishermen. The lord didn't have a lot of equipement to offer, he said that most of his money should go for the war effort, he was not totally wrong, but forgot we were the one giving him his money."),
  ("npc23_home_description", "I say this because I was wandering on the subject, but I never finished to talk about it. Military speaking, as it is a strategical position, it can be sieged and attacked numerous times. Sometimes in vain, some others successfully."),
  ("npc24_home_description", "You see, we, nords, are trained to fighter from our youngest age, that is why we are known as the best fighters in Calradia."),
  ("npc25_home_description", "It's a wonderful place to live in, I spent two years here, before I joined you. Before that my family used to get me here to relax. And there is much to be relaxed with here. The sea just a few steps from the village, the hot air of the desert lands nearby, with enough grass and water to feel good and live well, this place is my little heaven."),
  ("npc26_home_description", "Even though its position behind the mountains, this place is contested by both the sarranids and the khergits. Mostly because whoever controls Jameyyed controls one of the few entries to the desert, the sarranid lords want to keep that to them, to better defend themselves againsnt the khergits, while the khergits want it for an easier acces to the desert."),
  ...
  ("npc17_home_description_2", "There was once one of my men asking why we didn't loot that place, at first I didn't answered, knowing nothing to say, but later I told him that this place will be our one day, so we where not about to destroy what we will own no?"),
  ("npc18_home_description_2", "But the sultan didn't agree with this, he sent his armies, and the people around here couldn't do anything, this is at that time that my father and I left and he started to become famous for his trading. What a strange way to become famous."),
  ("npc19_home_description_2", "Unfortunatly my father didn't made througth it and my mom hanged herself, people from here took me as their son and made me believe my mother died of a disease too. But I am grateful to them for helping my family before, and me when I was alone. There was a girl I used to flirt with when I was a boy, she was so perfect, sometimes I regret having left this place."),
  ("npc20_home_description_2", "My parents told me of many wars, people used to come around, because it's quite far away from the fortified places so far from sieges, and it's not rich enough to be worth looting. Well to tell the truth we had some quite wealthy person coming around sometimes, one day, a group of people came here, amongst them was a very wealthy family, the father died because of a disease and the mother was raped and left for dead in the middle of nowhere, they had a little boy about my age, my parents never told him what really happened, and I understand why."),
  ("npc21_home_description_2", "Seeing the huge army we had during the battle, I think the lord had another idea in mind, pushing the Khergit back from our lands, and then, sieging one of their centers as they wouldn't be able to defend it. It seems it didn't go as planned."),
  ("npc22_home_description_2", "Hopefully, the hunters were not really in need of equipement, seeing what was available, so we had to do with what we had, taking woodcutter axes, and all we could find, we started marching for a long time. We were hunting them, but we didn't know where they were. Oh! And the captain we had, was given by the lord, even if he was of no use during the battle, because of what happened to him, he's proven to be a good help when we were marching to keep us together."),
  ("npc23_home_description_2", "The walls, even if they offer a protection for the defenders, are not exceptionaly strong or hard to take, we, Khergit have to rely on our strength and determination to win. This is most of the time accompanied by a huge number of projectiles, because yes, we use a lot of them, and when defending a town, it quickly becomes hell for the one trying to get up the walls."),
  ("npc24_home_description_2", "But even if we train to fight early on, we still have a lot to learn. That is why when a young boy wants to bring honor to his family and fight in battles, he is leaded to a place where he will be trained, unless his father can do that for him of course. I didn't have a father trained to fight, and I'm not mad at him for that. So, I've been there, I think even after all this I needed a real fight to really finish my training. I had that a little later, a swadian band tried to raid the nearby village of Ambean, we went there, and my training was over with a glorious victory."),
  ("npc25_home_description_2", "The forteress just above, is our barried against the sarranid lords, its walls are strong, and the men defending it are resolved to keep it ours. It makes it a really hard castle to take."),
  ("npc26_home_description_2", "I'm all for saying that we deserve it better than the khergits, we are the ones who built this fortification, we can see that from it's architecture. And these khergits only really want it to control the pass for the desert to launch raids against our villages more easily."),
  ...
  ("npc17_home_recap", "I was born overseas in a little village named Gurd, I never told you that, I thought this was not interesting for you."),
  ("npc18_home_recap", "I was born in {s21}, a prosperous village, and am the son of an incredible trader."),
  ("npc19_home_recap", "I was born in some big town as people told me, but I never knew which one, big walls, rich town, it's all that I know of."),
  ("npc20_home_recap", "I was born in the small village of {s21}, warsh climate but warmful people living in it."),
  ("npc21_home_recap", "Born in the city of Praven, I joined the army as soon as I could, after a time in the garison of the city, the king took me in his personal army."),
  ("npc22_home_recap", "Born in the village of Mazen, I joined a militia formed against some sea raiders, shortly after I joined you."),
  ("npc23_home_recap", "I was born in the small village of Amashke, when I became adult I went to Halmar, the closest town, to enlist in the army."),
  ("npc24_home_recap", "I was born in the forest near the village of Jelbegi, my father was a hunter, but he was not truly a warrior."),
  ("npc25_home_recap", "Chelez is the place I was born in, it's a village just inbetween two hills, so he have a lot of rainy days during the year, it makes every piece of ground a fresh green grassy field."),
  ("npc26_home_recap", "I'm from the village of Mazigh, a little place of heaven, even if it's easily raided by those khergit barbarians."),
  ...
  ("npc17_honorific", "{sir/madame}"), #sverre
  ("npc18_honorific", "{playername}"), #seis
  ("npc19_honorific", "{playername}"), #aethrod
  ("npc20_honorific", "{playername}"), #saorie
  ("npc21_honorific", "captain"), #ilya
  ("npc22_honorific", "{playername}"), #ysellian
  ("npc23_honorific", "my friend"), #khutza
  ("npc24_honorific", "{sir/madame}"), #uthred
  ("npc25_honorific", "{playername}"), #ireth
  ("npc26_honorific", "captain"), #merek
  ...
  ("npc17_kingsupport_1", "I'm not the one that can say what is good or not, but if you were to be {king/queen}, I'll do whatever I can to make your royal life more comfortable."), #sverre
  ("npc18_kingsupport_1", "Well, if you were to be {king/queen}, I hope you will not forget that a good {king/queen} is made to lead the men to peace and prosperity, not to make war, still it is sometimes necessary to declare war, but you will have to do it carefully and not to your people."),
  ("npc19_kingsupport_1", "I may not be the good person to judge about this but a {king/queen} must help his people and lead them to glory and so, like you did with me."),
  ("npc20_kingsupport_1", "You'd most certainly make an excelent {king/queen}, and I am not exagerating."),
  ("npc21_kingsupport_1", "Captain, I think this is a fine idea you've come up with."),
  ("npc22_kingsupport_1", "Ah! Yes, I that's a good idea {playername}, and I'd be glad to help you achieve this goal."),
  ("npc23_kingsupport_1", "Fine idea indeed, my friend. I say you are one able to bring what this world needs."),
  ("npc24_kingsupport_1", "You surely have what it takes to be {king/queen}, {sir/madame}."),
  ("npc25_kingsupport_1", "Well {playername}, this is a great idea, to my knowledge, you would make a perfect {king/queen} for these lands."),
  ("npc26_kingsupport_1", "Captain, you have just made me entirely thrilling."),
  ...
  ("npc17_kingsupport_2", "Of course I would. And with you as a {king/queen}, I think you will put an end to murders, looting and so."), #sverre
  ("npc18_kingsupport_2", "Of course, but I don't know how will I call you, my {lord/lady}? My {king/queen}? Or will I still be able to call you by your name... I think I need time to think about it ..."),
  ("npc19_kingsupport_2", "Sure, and I must add that you did very well with me so I do not see reason for you to have a bad one."),
  ("npc20_kingsupport_2", "Yes I would, but strange enough, that doesn't mean you don't need the support from the population, if you want, I can ride around the country in search for villages, and tell them of a great {king/queen}."),
  ("npc21_kingsupport_2", "Certainly I would, captain, that means you would need some support from the soldiers if you wish to have enoughmen to support your war effort."),
  ("npc22_kingsupport_2", "I would, certainly, but it's not an easy task done in a snap. So I could bring you some help, rallying the people from the villages. These men will later become yours, so it's better if they get that idea in mind before the moment, for them to get used to you, and to follow your moves a bit more."),
  ("npc23_kingsupport_2", "No doubt about that, there is no way I wouldn't help a friend such as yourself."),
  ("npc24_kingsupport_2", "It would be an honor {sir/madame}, I would gladly help you, I think there is something that could be done right now, if you would allow me."),
  ("npc25_kingsupport_2", "A very easy to answer question you ask me, of course I would, I could travel accros all of Calradia if it would guarantee your succes."),
  ("npc26_kingsupport_2", "I would have no other choice but to support you captain. As you are possibly the best to chose from. If you need, I can go and talk about your aspirations to the throne."),
  ...
  ("npc17_kingsupport_2a", "Please continue..."), #sverre
  ("npc18_kingsupport_2a", "We will discuss about that later, what do you have in mind?"),
  ("npc19_kingsupport_2a", "Yes..."),
  ("npc20_kingsupport_2a", "Interesting... Please continue"),
  ("npc21_kingsupport_2a", "Indeed yes... What do you propose?"),
  ("npc22_kingsupport_2a", "That's interseting..."),
  ("npc23_kingsupport_2a", "Do you think you could do something now?"),
  ("npc24_kingsupport_2a", "I'm listening..."),
  ("npc25_kingsupport_2a", "Talking of travels..."),
  ("npc26_kingsupport_2a", "Yes... Go on..."),
  ...
  ("npc17_kingsupport_2b", "I hope you understand that what you're asking is impossible."), #sverre
  ("npc18_kingsupport_2b", "A {king/queen} must declare war before the others do it, there is no need to wait for death if you can fight it."),
  ("npc19_kingsupport_2b", "You do not know me."),
  ("npc20_kingsupport_2b", "It's not exactly what I meant."),
  ("npc21_kingsupport_2b", "Hold that off, it's not a good idea."),
  ("npc22_kingsupport_2b", "It's too fast for now."),
  ("npc23_kingsupport_2b", "I'll keep that in mind."),
  ("npc24_kingsupport_2b", "No, I have something of my own to do."),
  ("npc25_kingsupport_2b", "Yes sure, but for now let's just get back to our buisness"),
  ("npc26_kingsupport_2b", "No, I wouldn't want to go too quickly."),
  ...
  ("npc17_kingsupport_3", "If you would please leave me for some times, I will go in a town, where I met a good man, he's a little like me, he want this banditry to end, and I don't think we're alone. He will dispatch the word that you will try to do all your possible to stop it if you're named {king/queen} of this land."),
  ("npc18_kingsupport_3", "You're right and this is why I propose you this: I go in towns and villages to tell them what you'll do as a {king/queen}, I'm sure a lot of them will support you."),
  ("npc19_kingsupport_3", "If you allow me I will go in towns and tell the story of a child whose father was killed because of the war and later when this now grown up boy was taken saved by a hero. I will not lie to them, and tell the thruth about you, as a good person and someone ready to save others with no reward."),
  ("npc20_kingsupport_3", "Well the great {king/queen} would be you of course, and I'm sure you know that in order to be respected by your people, you must know them, and more important, they must know you, that would be a task I could help you with, if you let me some times."),
  ("npc21_kingsupport_3", "If you leave me a few weeks, I will be able to rally some men to your cause, and maybe even take some of noble blood to support you."),
  ("npc22_kingsupport_3", "If that seems a good idea, I could a few weeks and I'd be able to realise it, going from one village to another"),
  ("npc23_kingsupport_3", "I had this thing yes, and my friend, this is something that you will like. I will try and get support for you, I'll go in the towns and villages, and I will make them understand that you are the one to be chosen as {king/queen} of these lands. I might not be of noble blood, which mean I wouldn't be as efficient as a respected lord, but I am a good speaker, and can at least rally the people around the nobles, which will then convince him that your reign would be profitable to them all."),
  ("npc24_kingsupport_3", "Well, seeing that you are a {man/woman} of the battlefields, I am sure you would have a lot of support coming from those with the heart of a warrior. They will think of you as being close to them, while still having the authority of them. But for that they need to know of your exploits, and of the numerous battles you've had. If you would to give me a few weeks, I could teach a good number of men about you."),
  ("npc25_kingsupport_3", "I was about to tell you, I have some acquaintance that would be a great help to your cause, some are just hermits, others are important persons highly placed in the nobility. I could convince these men to follow you and to support you, that will probably start rumors on your soon-to-be reign."),
  ("npc26_kingsupport_3", "Most people I will be talking to will surely understand and accept what I have to tell them, as I am quite a good speaker. Making you known through the lands is a very difficult task, and would you to give it to someone else than me, I wouldn't guarantee the succes of that action. Hopefully for you, there is no chance that I bring consternation in the common folk."),
  ...
  ("npc17_kingsupport_objection", "{!}"),
  ("npc18_kingsupport_objection", "{!}"),
  ("npc19_kingsupport_objection", "{!}"),
  ("npc20_kingsupport_objection", "{!}"),
  ("npc21_kingsupport_objection", "{!}"),
  ("npc22_kingsupport_objection", "{!}"),
  ("npc23_kingsupport_objection", "{!}"),
  ("npc24_kingsupport_objection", "{!}"),
  ("npc25_kingsupport_objection", "{!}"),
  ("npc26_kingsupport_objection", "{!}"),
...
#
  ...
  ("npc17_intel_mission", "As you may guess, I still have friends of my old past, and I learned that one of them is at {s17}. Well I could go there and report you anything he learned about the {s18}. What do you think?."),
  ("npc18_intel_mission", "{playername} I am still connected to other traders of the {s18}, and they know about everything you may want to know about them, I could have a conversation with some of them to learn more about {s18}. What do you say?."),
  ("npc19_intel_mission", "{playername} I wish to know more about the family that allowed me to be what I am right now, I heard that they are in {s17} right now and that they got enought money to be a respected family. They are high enough placed to know about {s18}. This will be good for both of us, I will see my old family and you will learn more about the {s18}."),
  ("npc20_intel_mission", "{playername}, I had some friends inside of {s17}, we used to trade some of our products, mostly furs, and sometimes iron, against whatever we could get. I think they would recognize me, and maybe they would allow me to learn more about the {s18}, so what do you say?."),
  ("npc21_intel_mission", "As a matter of fact captain, I still hae some contacts from within {s17} that would allow me to learn more about the {s18}."),
  ("npc22_intel_mission", "During my time serving in that militia, we first set route to the south of Jeirbe Castle, to Curaw, to gather some informations, I still have contacts in that town, my guess is that I could most likely pick up informations again, this time about the {s18}, and bring them to you these informations could be most useful to someone like you."),
  ("npc23_intel_mission", "I could be doing something for you my friend, in the town of Halmar, I have some former soldiers whom have become highly placed, these could get me some informations about the {s18}."),
  ("npc24_intel_mission", "I have an uncle in the city of {s17}, my parents would bring me there so I could get on his boat to fish. I could take the time to visit him, I'm sure he knows a lot about the {s18}, so it might as well help you."),
  ("npc25_intel_mission", "I would ask that you let me go to {s17} to visit my brother living there, it's been a long time since I last saw him. I told him about you, and what you do, by letter, and so he answered me that he could bring me some informations about the {s18}, you might find these valuable, and I will have an occasion to see him."),
  ("npc26_intel_mission", "If you will allow me, captain, I could go in the coatal city of {s17} to be informed of what happens in the {s18}."),
  ...
  ("npc20_fief_acceptance", "That is most unexpected {playername}, I can't believe you'd make me your vassal. It's true I wanted this to happen, but I had only small hopes on it."),
  ("npc21_fief_acceptance", "Captain? That is the most rejoicing thing you've said to me in... well since we've met each other in that tavern."),
  ("npc22_fief_acceptance", "You'd make me a great honor {playername}, I secretly have always dreamed of woning my part of land, and leading my men to battle."),
  ("npc23_fief_acceptance", "I had seen it coming for a few days already. At first I didn't want to trust my mind, thinking it was playing tricks on me, now I just know it was not a bad feeling of sadness, I must thank you with all my heart."),
  ("npc24_fief_acceptance", "These are, {sir/madame}, very nice words to hear from your mouth. You'd make me a noble with {s17} as my fief? Truly you are one of the few person I would consider to be good."),
  ("npc25_fief_acceptance", "{s17}? For me? Such a wonderfull day is the day of today. I would jump in your arms and kiss you, but that would probably be a lack of manners towards my {king/queen}. Still I thank you for all you've done to me, including making me of noble blood."),
  ("npc26_fief_acceptance", "That said, captain, I would gladly accept your offer and I swear I will protect this place and its people at the risk of my life."),
  ...
  ("npc20_woman_to_woman", "{playername}, there is something we need to talk about, your name is being slowly wispered all around Calradia, for if you would be a man, a king would have already tried to get you join his cause. Unfortunatly for us, seeing as we are women, I think it's up to you do make the first step."),
  ("npc21_woman_to_woman", "Captain, I think it's time for you to try to find a king willing to accept you as his vassal. I think that fighting for a cause can bring something that cannot be brought without a liege."),
  ("npc22_woman_to_woman", "{!}."),
  ("npc23_woman_to_woman", "{!}."),
  ("npc24_woman_to_woman", "{!}."),
  ("npc25_woman_to_woman", "{playername}, must I recall you that the kings in these lands are always looking for good warriors to fight alongside them? They'd rather have a man, as they are scared of what we can do, but as you've proven yourself to be more than a little threat for bandits, I think they will have to make an effort and get you with them, if they don't want their ennemies to have you"),
  ...
  ("npc18_turn_against", "{playername} I had hopped to meet you in the field, just to test your skills against me, we fought together, but now we are ennemies, still I think that we should be fair against each other shall we?"),
  ("npc19_turn_against", "It saddens me to see you on the other side of the battle {playername}, I had hopped that we would not meet on the field, that our friendship would not be messed. I hope that whoever win this battle we shall stay friends and later remind of this epic battle between two former partners."),
  ("npc20_turn_against", "Oh! {playername}, I had been torn between my will to meet you on the field, and my hopes of not having to cross your road. I think there is now no way to avoid what has already begun."),
  ("npc21_turn_against", "Captain, I think that as former allies, we should make this battle a 'friendly' battle, I mean that, I will respect the dead and the wounded on your side, and I hope you will do the same for me, if you get the upper hand of the fighting."),
  ("npc22_turn_against", "What a beautiful day for such battle awaiting. {playername}, I want you to try and stay focused on your commanding, I want to face you just like I knew you, ferocious, and tenacious."),
  ("npc23_turn_against", "A sad day is today, a day where friends have to fight because we cannot do otherwise. But mark my words my friend, I will always see you as a fellow comrade, even if you play dirty on this fight, weboth want to win, and I would understand if you would win by all means."),
  ("npc24_turn_against", "{Sir/Madame}, I hope that the bards and tellers of stories will sing and praise of this glorious battle that awaits us, I hopeyou and your men will fight fiercly, and that we both get out of it alive to share a drink later."),
  ("npc25_turn_against", "{playername}, I had tried until now to avoid getting into you... I mean... having to fight you on the field, I hope you will not take it badly if I say I want to win this fight. Maybe someday we will laugh together when reminding of this part of our life."),
  ("npc26_turn_against", "I have great respect in you captain, but the fact that we are ennemies means we have to fight against each other, unlike the old times."),
...
#multiplayer game type names
  ...
  ("new_debts", "New debts:"),
  ## bank_begin
  ("bank_money_for_s0", "Current money for {s0}'s bank:"),
  ("bank_interests_from_s0", "Interests from {s0}'s bank:"),
  ("bank_debt_for_s0", "Bank debts for {s0}:"),
  ## bank_end
  # mercenaries payment
  ("mercenary_payment_for_s0", "Mercenary payment for {s0}"),
...
##diplomacy end+
  ...
  ("rhodoks", "Rhodoks"),
  ("sarranids", "Sarranids"),
  ("khergit_tribes", "Khergit Tribes"),
  ("freeriders", "Freeriders"),
  ("mudle_confederacy", "Mudle Confederacy"),
  ("bandits", "bandits"),
  ("deserters", "deserters"),
...
#diplomacy end+
  ...
  ("stability_is_s8_current_party_morale_is_reg5_current_party_morale_modifiers_are__base_morale__50_party_size_s2reg1_leadership_s3reg2_food_variety_s4reg3s5s6_recent_events_s7reg4_total__reg5___", "Current party morale stability is {s8}.^Current party morale modifiers are:^^Base morale:  +{reg6}^Party size: {s2}{reg1}^Leadership: {s3}{reg2}^Food variety: {s4}{reg3}{s5}{s6}^TOTAL:  {reg5}^^^Current morale: {reg7}^^^"),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_2", "Ur {s0}"),
  ("faction_title_male_3", "Az Khan {s0}"),
  ("faction_title_male_4", "Thane {s0}"),
  ("faction_title_male_5", "Gaffer {s0}"),
  ("faction_title_male_6", "Padishah {s0}"),

  ("faction_title_female_player", "Lady {s0}"),
  ("faction_title_female_1", "Lady {s0}"),
  ("faction_title_female_2", "Urno {s0}"),
  ("faction_title_female_3", "{s0} Hatun"),
  ("faction_title_female_4", "Thane {s0}"),
  ("faction_title_female_5", "Gaffer {s0}"),
...
#diplomacy end+
  ...
  ("a_duel_between_you_and_s0_will_start_in_3_seconds", "A duel between you and {s0} has started!"),
...
##PBOD
  ...
  ("khergit_0", "Sovalye {s0}"),
  ("khergit_1", "Sef {s0}"),
  ("khergit_2", "Savas Sefi {s0}"),
  ("khergit_3", "Diktator {s0}"),
  ("khergit_4", "Az Khan {s0}"),
  ("khergit_5", "{s0} Khan"),
  
  ("nord_0", "Warrior {s0}"),
  ("nord_1", "War Chief {s0}"),
  ("nord_2", "War Lord {s0}"),
  ("nord_3", "Lesser Thane {s0}"),
  ("nord_4", "Thane {s0}"),
  ("nord_5", "Jarl {s0}"),
  
  ("rhodok_0", "Patrician {s0}"),
  ("rhodok_1", "Burgher {s0}"),
  ("rhodok_2", "Elder {s0}"),
  ("rhodok_3", "Leader {s0}"),
  ("rhodok_4", "Gaffer {s0}"),
  ...
  ("sarranid_3", "Emir {s0}"),
  ("sarranid_4", "Shah {s0}"),
  ("sarranid_5", "Padishah {s0}"),
  
  ("ladies_sw_0", "{s0}"),
  ("ladies_sw_1", "Baroness {s0}"),
  ("ladies_sw_2", "Viscountess {s0}"),
  ("ladies_sw_3", "Countess {s0}"),
  ("ladies_sw_4", "Lady {s0}"),
  ("ladies_sw_5", "Duchess {s0}"),
  
  ("ladies_va_0", "{s0}"),
  ("ladies_va_1", "Barono {s0}"),
  ("ladies_va_2", "Vargrofno {s0}"),
  ("ladies_va_3", "Grofno {s0}"),
  ("ladies_va_4", "Urno {s0}"),
  ("ladies_va_5", "Hercegno {s0}"),
  
  ("ladies_kh_0", "{s0} Hatun"),
  ("ladies_kh_1", "Sef {s0}"),
  ("ladies_kh_2", "Savas Sefi {s0}"),
  ("ladies_kh_3", "Diktator {s0}"),
  ("ladies_kh_4", "Az Khan {s0}"),
  ("ladies_kh_5", "{s0} Khan"),
  
  ("ladies_no_0", "Warrior {s0}"),
  ("ladies_no_1", "War Chief {s0}"),
  ("ladies_no_2", "War Lady {s0}"),
  ("ladies_no_3", "Lesser Thane {s0}"),
  ("ladies_no_4", "Thane {s0}"),
  ("ladies_no_5", "Jarl {s0}"),
  
  ("ladies_rh_0", "Patrician {s0}"),
  ("ladies_rh_1", "Burgher {s0}"),
  ("ladies_rh_2", "Elder {s0}"),
  ("ladies_rh_3", "Leader {s0}"),
  ("ladies_rh_4", "Gaffer {s0}"),
  ("ladies_rh_5", "Warden {s0}"),
  
  ("ladies_sa_0", "Sayeda {s0}"),
  ("ladies_sa_1", "Naib {s0}"),
  ("ladies_sa_2", "Malik {s0}"),
  ("ladies_sa_3", "Emir {s0}"),
  ("ladies_sa_4", "Shah {s0}"),
  ("ladies_sa_5", "Padishah {s0}"),
  
  ("knight_1_join", "Greetings. I was hoping in something a much more dirty in this place, you know newly created kingdom must face some hard times, I don't know whether you faced them already or you will soon, but I must admit that you're facing in a good maner political and military problems. What leads to the reason of my presence here, I wish to be one of your vasal."),
  ("knight_2_join", "Greetings, {my lord/my lady}. Some pretend that you wish to be {King/Queen} of these lands, I had to take a closer look at you before doing anything. And now I am ready to follow you in your victories and your defeats, that's why I pledge allegiance to you."),
  ("knight_3_join", "{My lord/My lady}. I know that you are now one of the pretender to the throne of Calradia, and I wish to pledge allegiance to you."),
  ("knight_4_join", "{My lord/My lady} I heard that you contest the other king's place for the throne, I must say I'm happy about that, because they all are unable to do anything."),
  ("knight_5_join", "Greetings, {my lord/my lady}. You may know that women are not allowed to lead men in battle in this world, but I hope that you are not one of them, and that I can join you as one of your vassal."),
  ("knight_5_join_female", "Greetings, {my lord/my lady}. When I heard that a woman claimed for the throne of Calradia I told myself that I should follow your growing, as noone else would let me be as a vasal because 'Ladies are not meant to fight'. I think that you have done well and I would be honored to pledge myself as your vassal."),
                                      # my lord should not appear
									  
  ("knight_1_accept", "If these hard times your thelling about are true, I would be glad to have you with us to face them."),
  ("knight_2_accept", "I accept your offer, you're now a part of our kingdom."),
  ("knight_3_accept", "I am pleased by your offer, welcome."),
  ("knight_4_accept", "You chose well, welcome in our ranks."),
  ("knight_5_accept", "No worries ma'am I am no man like that and I would be pleased to have you in our ranks."),
  ("knight_5_accept_female", "Finaly I was loosing hope for a woman other than me to try this hard task."),
  
  ("knight_1_refuse", "If you prefer dirty places I can let you help the peasants feed the cows."),
  ("knight_2_refuse", "No, all I have to say."),
  ("knight_3_refuse", "And I want you to get out of here imediatly before I make you arrested, and I hope I will never see you again or I should kill you."),
  ("knight_4_refuse", "You know, they may not be able to do anything but at the moment you're nothing else than a dirty peasant."),
  ("knight_5_refuse", "No I am not like them, because if they see you they do not want to kill you, now go out."),
  ("knight_5_refuse_female", "There only is one thing, I may be a woman but I am not like you, return to your duties at home and don't bother me again."),
  
  ("kill_lord", "The victim begs for mercy, to no avail, you slit his throat, he falls down and the ground begins to be filled with noble blood."),
  ("kill_soldier", "The victim begs for mercy, to no avail, you slit his throat, he falls down and the ground begins to be filled with blood."),
  ("kill_soldiers", "You get closer to them, and quickly kill them all without mercy."),
  ("kill_soldiers_lot", "They saw what you did, some of them are having their last prayer, others try to flee, some starts crying. But all of them are killed by you and your men with no pity."),
  
  ("you_lost_reg5_s10", "You lost {reg5} {s10}."),
  
  ("s40s41", "{s40}{s41}"),
  
  ("adventurer_name_1", "Alendil"),
  ("adventurer_name_2", "Dum"),
  ("adventurer_name_3", "Calar"),
  ("adventurer_name_4", "Mam"),
  ("adventurer_name_5", "Hord"),
  ("adventurer_name_6", "Friger"),
  ("adventurer_name_7", "Hjurd"),
  ("adventurer_name_8", "Fanon"),
  ("adventurer_name_9", "Arthur"),
  ("adventurer_name_10", "Eric"),
  ("adventurer_name_11", "Jean"),
  ("adventurer_name_12", "Ulric"),
  ("adventurer_name_13", "Joseph"),
  ("adventurer_name_14", "Geoffrey"),
  ("adventurer_name_15", "William"),
  ("adventurer_name_16", "Edmund"),
  ("adventurer_name_17", "Charles"),
  ("adventurer_name_18", "Robin"),
  ("adventurer_name_19", "Isak"),
  ("adventurer_name_20", "David"),
  ("adventurer_name_31", "Alex"),
  ("adventurer_name_32", "Randy"),
  ("adventurer_name_33", "Philip"),
  ("adventurer_name_34", "Gerald"),
  ("adventurer_name_35", "Barney"),
  ("adventurer_name_36", "Ivan"),
  ("adventurer_name_37", "Thomas"),
  ("adventurer_name_38", "Alfred"),
  ("adventurer_name_39", "Martin"),
  ("adventurer_name_40", "Cyril"),
  ...
  ("sufix_5", " of Ichamur"),
  ("sufix_6", " of Shariz"),
  ("sufix_7", " the Hand Shaking"),
  ("sufix_8", " the Big"),
  ("sufix_9", " the Good"),
  ("sufix_10", " the Fat"),
  ("sufix_11", " the Bastard"),
  ("sufix_12", " the Great"),
  ("sufix_13", " the Immortal"),
  ("sufix_14", " the Pleasant"),
  ("sufix_15", " Endil"),
  ("sufix_16", " Falmir"),
  ("sufix_17", " the Missed"),
  ("sufix_18", " the Brave"),
  ("sufix_19", " the Courageous"),
  ("sufix_20", " the Unbeatable"),
  ("sufix_31", " the Undefeated"),
  ("sufix_32", " the Grand"),
  ("sufix_33", " the Coward"),
  ("sufix_34", " the Tenacious"),
  ("sufix_35", "{!!}"),
  ("sufix_36", "{!!}"),
  ("sufix_37", "{!!}"),
  ("sufix_38", "{!!}"),
  ...
  # ("sufix_9", ""),
  # ("sufix_0", ""),
  ("sufix_end", "suffix_end ! ERROR !"),
  
  ("mercenary_intro_bad_a", "Well, what we have here, I hope for you it will be true, but I am sure a lowly born person like you will stay in your mud forever."),
  ("mercenary_intro_bad_b", "Anyways, I am pleased to meet you."),
  ("mercenary_intro_bad_c", "Hah! I like that spirit! Without a big ambition you don't go realy far. So what is it?"),
  ("mercenary_intro_bad_d", "{!}ERROR SHOULD NOT APEAR"),
  
  ("mercenary_give_land_reject_a", "Make up you mind before saying stupid things then."),
  ("mercenary_give_land_reject_b", "I had hoped you wouldn't give me any fake ideas."),
  ("mercenary_give_land_reject_c", "I had hoped you wouldn't give me any fake ideas."),
  ("mercenary_give_land_reject_d", "You should stop making jokes like this one."),
  
  ("mercenary_duties_a", "Heh? A tricky question you ask me there, I'd say that as a mercenary you are supposed to honor your king and serve him."),
  ("mercenary_duties_b", "We are supposed to serve the king and obey him under any circumtance, but I tell you, it does not work that way, we just fight for gold, we are men too and don't want to die."),
  ("mercenary_duties_c", "Duties ? There is no duty as a mercenary, we are given gold to kill some poor bastards and there is no counterpart."),
  ("mercenary_duties_d", "We do serve under the banner of one king, we got to obey him and do as he wishes, so the duties realy depend only on who you serve."),
  
  ("mercenary_benefits_a", "In my opinion the benefits of being a mercenary is that you don't have to watch for your territory, and you get paid in gold by the king himself."),
  ("mercenary_benefits_b", "Money. This is the most powerful weapon and we get it from the king, a safe source."),
  ("mercenary_benefits_c", "Killing with no worries of the law, and getting paid for it ? How can someone find a better job?"),
  ("mercenary_benefits_d", "We get to defend our homeland without having to be of noble blood, this a great honor to me."),
  
  ("mercenary_future_a", "No, it is too much obligations, having to watch for your people, hear them complain about someone that stole their cheese."),
  ("mercenary_future_b", "It wouldn't be a bad idea, collecting taxes from the folk can bring quite its weight, but I do not dream about it too much, we, the common folk cannot have acces to this privilege."),
  ("mercenary_future_c", "Of course not, when being a noble you have to be careful on what you do, because everyone is watching you and they wait for you to make a mistake."),
  ("mercenary_future_d", "I do yes, one day I will become one, owning my own part of land, having people under my order, not that I don't have right now, but those are sword for hire, they do not care about anything else than money, and they make me remember it week."),
  
  ("mercenary_vassal_accept_a", "You would? I've never realy wanted to become one, but it was knowing no one would ask me. I suppose there is no real harm in accepting your proposition. What land are you thinking about?"),
  ("mercenary_vassal_accept_b", "Hah! That would make me nobleman. I had lost hope to become one. But what am I saying, I would be honored to pledge myself as your vassal."),
  ("mercenary_vassal_accept_c", "You know, I've never wanted that, but I've never had the occasion to try it either and it is better to talk about something you know, so I'll give it a try, and wo knows I might start liking my new life."),
  ("mercenary_vassal_accept_d", "You would? This has to be the best day of my life, after a long life of working under the order of some narcissistic king, finaly one of them, not so like what I thought, decides to give me a chance. I shall not disapoint you."),

  ("mercenary_intro_fight_a", "I am fairly sure you know why I came to cross your road, I would just like to know the name of the one I meet on the field before coming to blows."),
  ("mercenary_intro_fight_b", "I do not know you and I have to fight you. As I cannot change the second part, would you be kind to help me know you?"),
  ("mercenary_intro_fight_c", "A good battle is preparing, I hope your men will fight fiercy and die with honor. What is the name of the leader?"),
  ("mercenary_intro_fight_d", "{My good man/My lady}, I am sorry I have to do this, but we will have to trade blows in the next minutes, I would ask to know your name so I can tell of your prowess at a later date."),

  ("mercenary_resting",       "We are resting at {s1}."),
  ("mercenary_travelling",    "We are travelling to {s1}."),
  ("mercenary_recruiting",    "We are recruiting new soldiers from {s1}."),
  ("mercenary_patrolling",    "We are scouting for the enemy around {s1}."),
  ("mercenary_raiding",       "We are laying waste to the village of {s1}."),
  ("mercenary_retreating",    "We are retreating to {s1}."),
  ("mercenary_besieging",     "We are besieging {s1}."),
  ("mercenary_engaging",      "We are fighting against {s1}."),
  ("mercenary_screening",     "I am screening {s1}'s advance."),
  ("mercenary_accompanying",  "We are accompanying {s1}."),
  ("mercenary_nothing",       "We are reconsidering our next objective."),
  
  
  ("stability_90", "Steadfast"),
  ("stability_75", "Steady"),
  ("stability_60", "Strong"),
  ("stability_45", "Average"),
  ("stability_30", "Feeble"),
  ("stability_15", "Poor"),
  ("stability_0", "Horrible"),
  ("stability_negative", "Dreadful"),
  
  
  ("end_of_strings", "end_of_strings !should not appear!"),
]
