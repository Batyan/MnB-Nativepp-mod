...
#																								|Nobles							|Top tier/Tier2						|Tier1/Tier2 Ranged					|Tier3
#############################################################################################################################################################################################################################################################################################
...
#############################################################################################################################################################################################################################################################################################
  ...
  ("kingdom_2_reinforcements_ba", "{!}kingdom_2_reinforcements_ba", 0, 0, fac_commoners, 0, [									(trp_vaegir_footman,4,8),			(trp_vaegir_recruit,5,10),										(trp_vaegir_scout,2,4),	(trp_watchman,1,2)]),
...
#############################################################################################################################################################################################################################################################################################
#############################################################################################################################################################################################################################################################################################
  ("kingdom_3_reinforcements_a", "{!}kingdom_3_reinforcements_a", 0, 0, fac_commoners, 0, [										(trp_khergit_skirmisher,8,16),		(trp_khergit_tribesman,5,10),		(trp_khergit_steppe_fighter,2,4)]),
  ("kingdom_3_reinforcements_b", "{!}kingdom_3_reinforcements_b", 0, 0, fac_commoners, 0, [		(trp_khergit_noble,1,2),		(trp_khergit_skirmisher,10,20),											(trp_khergit_steppe_fighter,1,2),	(trp_khergit_archer,1,2),	(trp_watchman,0,1)]),
  ("kingdom_3_reinforcements_c", "{!}kingdom_3_reinforcements_c", 0, 0, fac_commoners, 0, [		(trp_khergit_noble,2,4),		(trp_khergit_horseman,6,12),											(trp_khergit_soldier,1,2)]),
  ("kingdom_3_reinforcements_aa", "{!}kingdom_3_reinforcements_aa", 0, 0, fac_commoners, 0, [									(trp_khergit_skirmisher,8,16),		(trp_khergit_tribesman,5,10),		(trp_khergit_steppe_fighter,2,4)]),
  ("kingdom_3_reinforcements_ab", "{!}kingdom_3_reinforcements_ab", 0, 0, fac_commoners, 0, [	(trp_khergit_noble,1,2),		(trp_khergit_skirmisher,8,16),											(trp_khergit_steppe_fighter,3,6),	(trp_khergit_archer,1,2),	(trp_watchman,0,1)]),
  ("kingdom_3_reinforcements_ac", "{!}kingdom_3_reinforcements_ac", 0, 0, fac_commoners, 0, [	(trp_khergit_noble,2,4),		(trp_khergit_horseman,5,10),											(trp_khergit_soldier,2,4)]),
  ("kingdom_3_reinforcements_ba", "{!}kingdom_3_reinforcements_ba", 0, 0, fac_commoners, 0, [									(trp_khergit_skirmisher,7,14),		(trp_khergit_tribesman,5,10),		(trp_khergit_steppe_fighter,2,4),								(trp_watchman,1,2)]),
  ("kingdom_3_reinforcements_bb", "{!}kingdom_3_reinforcements_bb", 0, 0, fac_commoners, 0, [	(trp_khergit_noble,1,2),		(trp_khergit_skirmisher,8,16),											(trp_khergit_steppe_fighter,1,2),	(trp_khergit_archer,1,2),	(trp_watchman,2,5)]),
  ("kingdom_3_reinforcements_bc", "{!}kingdom_3_reinforcements_bc", 0, 0, fac_commoners, 0, [	(trp_khergit_noble,2,4),		(trp_khergit_horseman,6,10),											(trp_khergit_soldier,1,2)]),
...
#############################################################################################################################################################################################################################################################################################
  ...
  ("kingdom_4_reinforcements_b", "{!}kingdom_4_reinforcements_b", 0, 0, fac_commoners, 0, [		(trp_nord_noble,1,2),			(trp_nord_footman,4,8),				(trp_nord_huntsman,4,8),			(trp_nord_trained_footman,2,4),	(trp_watchman,0,1)]),
  ...
  ("kingdom_4_reinforcements_ab", "{!}kingdom_4_reinforcements_ab", 0, 0, fac_commoners, 0, [	(trp_nord_noble,1,2),			(trp_nord_footman,2,4),				(trp_nord_huntsman,6,12),			(trp_nord_trained_footman,2,4),	(trp_watchman,0,1)]),
  ("kingdom_4_reinforcements_ac", "{!}kingdom_4_reinforcements_ac", 0, 0, fac_commoners, 0, [	(trp_nord_noble,2,4),			(trp_nord_warrior,1,2),				(trp_nord_archer,1,2),				(trp_nord_trained_footman,4,8)]),
  ...
  ("kingdom_4_reinforcements_bb", "{!}kingdom_4_reinforcements_bb", 0, 0, fac_commoners, 0, [	(trp_nord_noble,1,2),			(trp_nord_footman,4,8),				(trp_nord_huntsman,2,4),			(trp_nord_trained_footman,2,4),	(trp_watchman,2,5)]),
...
#############################################################################################################################################################################################################################################################################################
  ...
  ("kingdom_5_reinforcements_b", "{!}kingdom_5_reinforcements_b", 0, 0, fac_commoners, 0, [		(trp_rhodok_noble,1,2),			(trp_rhodok_spearman,4,8),			(trp_rhodok_crossbowman,6,12),												(trp_watchman,0,1)]),
...
#############################################################################################################################################################################################################################################################################################
  ...
  ("kingdom_6_reinforcements_b", "{!}kingdom_6_reinforcements_b", 0, 0, fac_commoners, 0, [		(trp_sarranid_noble,1,2),		(trp_sarranid_footman,6,12),		(trp_sarranid_veteran_footman,3,6),	(trp_sarranid_skirmisher,1,2),	(trp_watchman,0,1)]),
  ...
  ("kingdom_6_reinforcements_bb", "{!}kingdom_6_reinforcements_bb", 0, 0, fac_commoners, 0, [	(trp_sarranid_noble,1,2),		(trp_sarranid_footman,4,8),			(trp_sarranid_veteran_footman,1,2),	(trp_sarranid_skirmisher,3,6),	(trp_watchman,2,5)]),
...
#############################################################################################################################################################################################################################################################################################
#############################################################################################################################################################################################################################################################################################
  ("kingdom_7_reinforcements_a", "{!}kingdom_7_reinforcements_a", 0, 0, fac_commoners, 0, [										(trp_watchman,7,14),				(trp_farmer,3,6),					(trp_townsman,1,2),		(trp_follower_woman,1,2)]),
  ...
  ("kingdom_7_reinforcements_aa", "{!}kingdom_7_reinforcements_aa", 0, 0, fac_commoners, 0, [									(trp_watchman,7,14),				(trp_farmer,3,6),					(trp_townsman,1,2),		(trp_follower_woman,1,2)]),
  ...
  ("kingdom_7_reinforcements_ba", "{!}kingdom_7_reinforcements_ba", 0, 0, fac_commoners, 0, [									(trp_watchman,6,12),				(trp_farmer,2,4),					(trp_townsman,1,2),		(trp_follower_woman,2,4),		(trp_hunter_woman,1,2)]),
...
#############################################################################################################################################################################################################################################################################################
  ...
  ("kingdom_8_reinforcements_b", "{!}kingdom_8_reinforcements_b", 0, 0, fac_commoners, 0, [		(trp_freerider_noble,1,2),		(trp_footman,4,8),					(trp_light_infantry,2,4),			(trp_spotter,2,4),		(trp_trainee,2,4),	(trp_watchman,0,1)]),
  ("kingdom_8_reinforcements_c", "{!}kingdom_8_reinforcements_c", 0, 0, fac_commoners, 0, [		(trp_freerider_noble,2,4),		(trp_light_cavalry,3,6),			(trp_light_infantry,2,4),									(trp_trainee,1,2)]),
  ...
  ("kingdom_8_reinforcements_ab", "{!}kingdom_8_reinforcements_ab", 0, 0, fac_commoners, 0, [	(trp_freerider_noble,1,2),		(trp_footman,4,8),					(trp_light_infantry,1,2),			(trp_spotter,2,4),		(trp_trainee,3,6),	(trp_watchman,0,1)]),
  ("kingdom_8_reinforcements_ac", "{!}kingdom_8_reinforcements_ac", 0, 0, fac_commoners, 0, [	(trp_freerider_noble,2,4),		(trp_light_cavalry,3,6),			(trp_light_infantry,1,2),									(trp_trainee,2,4)]),
  ...
  ("kingdom_8_reinforcements_bb", "{!}kingdom_8_reinforcements_bb", 0, 0, fac_commoners, 0, [	(trp_freerider_noble,1,2),		(trp_footman,4,8),					(trp_light_infantry,2,4),									(trp_trainee,2,4),	(trp_watchman,2,5)]),
  ("kingdom_8_reinforcements_bc", "{!}kingdom_8_reinforcements_bc", 0, 0, fac_commoners, 0, [	(trp_freerider_noble,2,4),		(trp_light_cavalry,3,6),			(trp_light_infantry,2,4),									(trp_trainee,1,2)]),
...
#############################################################################################################################################################################################################################################################################################
  ...
  ("kingdom_5a_reinforcements_ba", "{!}kingdom_5a_reinforcements_ba", 0, 0, fac_commoners, 0, [									(trp_rhodok_swordman,5,10),			(trp_rhodok_tribesman,5,10),		(trp_rhodok_spearman,1,2),				(trp_watchman,1,2)]),
