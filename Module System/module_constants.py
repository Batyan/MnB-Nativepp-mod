...
slot_item_adventurer_preference_begin = 60 #to make the adventurers buy weapons according to their type and culture
										   #reserve 160 slots after this one
...
slot_agent_combat_stance      = 26 # 0 = defending / 1 = changing state to defend / 2 = attacking / 3 = has hit the ennemy, can hit again
slot_agent_defend_time      = 27
slot_agent_min_check_time      = 28
slot_agent_timer_start      = 29
slot_agent_timer_depleted      = 30
...
slot_faction_num_center = 66

slot_faction_last_death = 67

slot_faction_rebel_without_player = 68
...
slot_faction_reinforcements_d        = 88
...
slot_center_player_enterprise_consumption_order   = 149 #not used
...
#### change equipement
slot_troop_equipement_level    = 23
slot_troop_lord_level          = 15
#### change equipement
...
slot_troop_gold_carried = 155

slot_troop_item_slot_used = 156
...
slot_troop_exp      = 162
slot_troop_adventurer_type = 163



at_melee_1 = 0 # melee 1h
at_melee_2 = 1 # melee 1h + throw
at_melee_3 = 2 # mounted melee 1h
at_melee_4 = 3 # mounted melee 1h + throw
at_melee_5 = 4 # melee 2h/pole
at_melee_6 = 5 # melee 2h/pole + throw
at_melee_7 = 6 # mounted melee 2h/pole
at_melee_8 = 7 # mounted melee 2h/pole + throw

at_xbow_1 = 12 # foot crossbow
at_xbow_2 = 13 # foot crossbow w/melee
at_xbow_3 = 14 # mounted crossbow
at_xbow_4 = 15 # mounted crossbow w/melee

at_archer_1 = 16 # foot archer
at_archer_2 = 17 # foot archer w/melee
at_archer_3 = 18 # mounted archer
at_archer_4 = 19 # mounted archer w/melee

slot_troop_culture_type = 164
...
slot_troop_next_action_preference = 165
a_buy = 0x01
a_recruit = 0x10

slot_troop_special_unit = slot_troop_adventurer_type

slot_troop_mercenary_time = slot_troop_days_on_mission # used for mercenary contracts
slot_troop_next_mercenary_faction = slot_troop_exp

# not used
slot_troop_weapon_used = slot_troop_adventurer_type

slot_troop_mercenary_payment_for_player = slot_troop_gold_carried
...
slto_adventurer = 10 # adventurers like the player

slto_kingdom_mercenary = 11
...
#lreps for mercenaries
lrep_goldlover    = 12 #is a mercenary for the love of gold, will probably end himself in bad situations because of it
lrep_deathbringer = 15 #only here to kill the poor soldier in service does not accord much importance to its life, but takes courage and a good fight in a good position
lrep_goodwilling  = 16 #comes from the common folk, and tries to improve its standing and become a noble, can become what he hated the most
lrep_unfamous     = 14 # is a bit bored of its situation, but cannot do much to change it
...
kingdom_mercenaries_begin = "trp_adventurer_01"
kingdom_mercenaries_end   = "trp_kingdom_1_pretender"
...
tavern_booksellers_end   = "trp_tavern_weaponsmith_1"
...
smith_begin = "trp_tavern_weaponsmith_1"
smith_end   = tavern_minstrels_begin
...
ammo_end = "itm_pilgrim_disguise"

# Banner constants

banner_meshes_begin = "mesh_banner_a01"
banner_meshes_end_minus_one = "mesh_banner_mesh_end"
...
btactic_follow_leader_pack = 6
btactic_follow_leader_foot = 7
btactic_follow_leader_archer = 8
...
arena_tier1_prize = 30
arena_tier2_opponents_to_beat = 6
arena_tier2_prize = 60
arena_tier3_opponents_to_beat = 10
arena_tier3_prize = 100
arena_tier4_opponents_to_beat = 15 ##new 0.751
arena_tier4_prize = 160 ##new 0.751
arena_tier5_opponents_to_beat = 20 ##new 0.751
arena_tier5_prize = 240 ##new 0.751
arena_grand_prize = 600
...
noble_troops_begin = "trp_noble_begin"
noble_troops_end = "trp_noble_end"
## recruit nobles end   ##

adventurer_names_begin = "str_adventurer_name_1"
adventurer_names_end = "str_sufix_1"
