...
##diplomacy end
   ...
   (0.1, 0, ti_once, [], [(try_for_range, ":cur_troop", lords_begin, lords_end),
						   (store_proficiency_level, ":wp", ":cur_troop", 0),
						   (val_sub, ":wp", 90),
						   (val_div, ":wp", 30),
						   (troop_set_slot, ":cur_troop", slot_troop_equipement_level, ":wp"),
						 (try_end),
						]),
     ...
     (try_for_range, ":companion", companions_begin, companions_end),
       ...
       (try_for_range, ":i_slot", 0, ":inv_cap"),
		 ...
		 (ge, ":item_id", 0),
	 	 ...
	 	 (this_or_next|eq, ":item_id", "itm_sword_two_handed_b"),
