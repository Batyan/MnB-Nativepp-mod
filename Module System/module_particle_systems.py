...
particle_systems = [
    ...
    ("game_rain", psf_billboard_2d|psf_global_emit_dir|psf_always_emit, "prtcl_rain",
     600, 0.5, 0.33, 1.0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (1.0, 0.3), (1, 0.3),        #alpha keys
     (1.0, 0.8), (1, 0.8),      #red keys
     (1.0, 0.8), (1, 0.8),      #green keys
     (1.0, 0.8), (1, 0.8),      #blue keys
     (1.0, 0.4),   (1.0, 0.4),   #scale keys
...
##    
    ("game_blood", psf_billboard_3d |psf_randomize_size|psf_randomize_rotation,  "prt_mesh_blood_1",
     2500, 3.3, 3, 0.65, 0, 0,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.7), (0.7, 0.01),          #alpha keys
     (0.1, 0.40), (1, 0.35),      #red keys
     (0.1, 0.25), (1, 0.20),       #green keys
     (0.1, 0.25), (1, 0.20),      #blue keys
     (0.0, 0.015),   (0.5, 0.018),  #scale keys
     (0, 0.05, 0),               #emit box size
     (0, 1.3, 0.4),                #emit velocity
     0.9,                       #emit dir randomness
     0,                         #rotation speed
     0,                         #rotation damping
    ),
    ("game_blood_2", psf_billboard_3d | psf_randomize_size|psf_randomize_rotation ,  "prt_mesh_blood_3",
     2000, 3, 3, 0.7, 0, 0,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.2), (0.7, 0.05),        #alpha keys
     (0.1, 0.6), (1, 0.55),      #red keys
     (0.1, 0.3), (1, 0.25),       #green keys
     (0.1, 0.3), (1, 0.25),      #blue keys
     (0.0, 0.15),   (1, 0.35),    #scale keys
     (0.01, 0.2, 0.01),             #emit box size
     (0.7, 1.6, 0),                 #emit velocity
