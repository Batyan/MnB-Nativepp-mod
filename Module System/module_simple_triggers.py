  ...
  #    (start_presentation, "prsnt_custom_banner"),
	...
	(else_try), # player is a mercenary for one of the factions
	  ...
	  (try_begin),
		...
		(assign, ":banner_icon_id", "icon_banner_01"),
      (else_try),
        (eq, "$players_kingdom", "fac_kingdom_2"),
        (assign, ":banner_id", "spr_banner_b"),
		(assign, ":banner_icon_id", "icon_banner_02"),
      (else_try),
        (eq, "$players_kingdom", "fac_kingdom_3"),
        (assign, ":banner_id", "spr_banner_c"),
		(assign, ":banner_icon_id", "icon_banner_03"),
      (else_try),
        (eq, "$players_kingdom", "fac_kingdom_4"),
        (assign, ":banner_id", "spr_banner_d"),
		(assign, ":banner_icon_id", "icon_banner_04"),
      (else_try),
        (eq, "$players_kingdom", "fac_kingdom_5"),
        (assign, ":banner_id", "spr_banner_e"),
		(assign, ":banner_icon_id", "icon_banner_05"),
      (else_try),
        (eq, "$players_kingdom", "fac_kingdom_6"),
        (assign, ":banner_id", "spr_banner_f01"),
		(assign, ":banner_icon_id", "icon_banner_116"),
	  (else_try),
        (eq, "$players_kingdom", "fac_kingdom_9"),
  ...
  (24, ## change names corresponding to the occupation
   ...
   (24*7, ##add lords to player faction  ## TRIGGER 116
    [(assign, ":not", 1),
	 ...
	 (store_random_in_range, ":troop_no", "trp_knight_7_1", "trp_kingdom_1_pretender"), # 5 free lords available
